...
void Class_1_dtor(godot_object *p_instance, void *p_method_data, struct Class_1_struct_t *p_user_data)
    ...
    godot_variant **p_args)
{
    ...
    if (0 == Class_1_call_method_constants_initialized)
    {
        ...
        {
            uint8_t data[] = {2, 0, 0, 0, 2, 0, 0, 0};
            gd2c->godot_variant_decode(&Class_1_call_method_constants[1], data, 8, 2, true);
        }
...

{
    ...
    godot_variant *args[] = {&Class_1_call_method_constants[0], &Class_1_call_method_constants[1]};

    stack[0] =
        p_user_data->__vtable->methods[1](
            p_instance,
            p_method_data,
            p_user_data,
            2,
...
void Class_3_dtor(godot_object *p_instance, void *p_method_data, struct Class_3_struct_t *p_user_data)
...
void GDN_EXPORT GD2C__gdnative_init(godot_gdnative_init_options *p_options)
{
...
void GDN_EXPORT GD2C__gdnative_terminate(godot_gdnative_terminate_options *p_options)
{
    ...
    if (0 != Class_1_call_method_constants_initialized)
    {
        ...
        api10->godot_variant_destroy(&Class_1_call_method_constants[1]);
    }
    ...
    if (0 != Class_3__init_constants_initialized)
    {
    }
    ...
    if (0 != Class_3_method2_constants_initialized)
    {
    }
}
