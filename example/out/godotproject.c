...
godot_variant Class_1_godot_array_get_func(
    godot_object *p_instance,
    void *p_method_data,
    void *_p_user_data,
    int p_num_args,
    godot_variant **p_args)
{
    ...
    goto _entry;
_entry:
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x053AD2D0>;
    // DEFINE 67108864;
    ...
    godot_variant **p_args)
{
    ...
    goto _entry;
_entry:
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x053A09F0>;
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x053A0A10>;
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x053A0A30>;
    // DEFINE 67108864;
    // DEFINE 67108865;
    api10->godot_variant_new_nil(&st_83886083);
    goto _0;
...
godot_variant Class_1_godot_array_set_func(
    godot_object *p_instance,
    void *p_method_data,
    void *_p_user_data,
    int p_num_args,
    godot_variant **p_args)
{
    ...
    goto _entry;
_entry:
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x053A0990>;
    // DEFINE 67108864;
    goto _0;
_0:
    goto _2;
...
void Class_1_vtable_init()
{
    ...
    VTABLE_METHOD(Class_1_vtable,
                  1,
                  "godot_array_get",
                  Class_1_godot_array_get_func,
                  (void *)0);

    VTABLE_METHOD(Class_1_vtable,
                  2,
                  "nested_loop",
                  Class_1_nested_loop_func,
                  (void *)0);

    VTABLE_METHOD(Class_1_vtable,
                  3,
                  "with_defargs",
                  Class_1_with_defargs_func,
                  (void *)0);

    VTABLE_METHOD(Class_1_vtable,
                  4,
                  "godot_array_set",
                  Class_1_godot_array_set_func,
                  (void *)0);
}
