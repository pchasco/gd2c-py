...
{
    //printf("Enter: Class_1_test_parameter_copy_uses_func\n");
    struct Class_1_struct_t *p_user_data = (struct Class_1_struct_t *)_p_user_data;
    godot_bool __flag;
    godot_variant_call_error __error;
    godot_variant __return_value;
    ...
    goto _entry;
_entry:
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x103172198>;
    if (p_num_args > 0)
        api10->godot_variant_new_copy(&st_2, p_args[0]);
    goto _0;
_0:
    goto _2;
_2:
    api10->godot_variant_new_copy(&__return_value, &st_2);
    goto _2147483646;
    goto _2147483646;
_2147483646:
    ...
    goto _cleanup;
_cleanup:
    //printf("Exit: Class_1_test_parameter_copy_uses_func\n");
    return __return_value;
}
...
{
    //printf("Enter: Class_1_test_parameter_copy_defs_func\n");
    struct Class_1_struct_t *p_user_data = (struct Class_1_struct_t *)_p_user_data;
    godot_bool __flag;
    godot_variant_call_error __error;
    godot_variant __return_value;
    api10->godot_variant_new_nil(&__return_value);
    if (0 == Class_1_test_parameter_copy_defs_local_const_initialized)
    {
        {
            uint8_t data[] = {2, 0, 0, 0, 2, 0, 0, 0};
            int bytesRead;
            gd2c10->variant_decode(&Class_1_test_parameter_copy_defs_local_const[0], data, 8, &bytesRead, true);
        }
        Class_1_test_parameter_copy_defs_local_const_initialized = 1;
    }
    godot_variant st_2;
    godot_variant st_3;
    goto _entry;
_entry:
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x1031724a8>;
    // DEFINE 67108864;
...
_0:
    goto _2;
_2:
    api11->godot_variant_evaluate(8, &st_3, &Class_1_test_parameter_copy_defs_local_const[0], &st_2, &__flag);
    api10->godot_variant_new_copy(&st_3, &st_2);
    api10->godot_variant_new_copy(&__return_value, &st_3);
    goto _2147483646;
    goto _2147483646;
_2147483646:
    api10->godot_variant_destroy(&st_2);
    ...
    goto _cleanup;
_cleanup:
    //printf("Exit: Class_1_test_parameter_copy_defs_func\n");
    return __return_value;
}
...
{
    //printf("Enter: Class_1_test_parameter_copy_uses_with_defarg_func\n");
    struct Class_1_struct_t *p_user_data = (struct Class_1_struct_t *)_p_user_data;
    godot_bool __flag;
    godot_variant_call_error __error;
    godot_variant __return_value;
    api10->godot_variant_new_nil(&__return_value);
    if (0 == Class_1_test_parameter_copy_uses_with_defarg_local_const_initialized)
    {
        {
            uint8_t data[] = {2, 0, 0, 0, 1, 0, 0, 0};
            int bytesRead;
            gd2c10->variant_decode(&Class_1_test_parameter_copy_uses_with_defarg_local_const[0], data, 8, &bytesRead, true);
        }
        Class_1_test_parameter_copy_uses_with_defarg_local_const_initialized = 1;
    }
    godot_variant st_3;
    goto _entry;
_entry:
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x103172a90>;
    // DEFINE 67108864;
    if (p_num_args > 0)
        api10->godot_variant_new_copy(&st_3, p_args[0]);
    goto _0;
...
_2147483646:
    ...
    goto _cleanup;
_3:
    api10->godot_variant_new_copy(&st_3, &Class_1_test_parameter_copy_uses_with_defarg_local_const[0]);
    goto _8;
_cleanup:
    //printf("Exit: Class_1_test_parameter_copy_uses_with_defarg_func\n");
    return __return_value;
}
...
{
    //printf("Enter: Class_1_test_parameter_copy_defs_with_defarg_func\n");
    struct Class_1_struct_t *p_user_data = (struct Class_1_struct_t *)_p_user_data;
    godot_bool __flag;
    godot_variant_call_error __error;
    godot_variant __return_value;
    api10->godot_variant_new_nil(&__return_value);
    if (0 == Class_1_test_parameter_copy_defs_with_defarg_local_const_initialized)
    {
        {
            uint8_t data[] = {2, 0, 0, 0, 1, 0, 0, 0};
            int bytesRead;
            gd2c10->variant_decode(&Class_1_test_parameter_copy_defs_with_defarg_local_const[0], data, 8, &bytesRead, true);
        }
        {
            uint8_t data[] = {2, 0, 0, 0, 2, 0, 0, 0};
            int bytesRead;
            gd2c10->variant_decode(&Class_1_test_parameter_copy_defs_with_defarg_local_const[1], data, 8, &bytesRead, true);
        }
        {
            uint8_t data[] = {2, 0, 0, 0, 3, 0, 0, 0};
            int bytesRead;
            gd2c10->variant_decode(&Class_1_test_parameter_copy_defs_with_defarg_local_const[2], data, 8, &bytesRead, true);
        }
        Class_1_test_parameter_copy_defs_with_defarg_local_const_initialized = 1;
    }
    godot_variant st_4;
    godot_variant st_5;
    godot_variant st_6;
    ...
    goto _entry;
_entry:
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x10317d240>;
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x10317d1d0>;
    // <gd2c.bytecode.ParameterGDScriptOp object at 0x10317d278>;
    // DEFINE 67108864;
    // DEFINE 67108865;
    // DEFINE 67108866;
    api10->godot_variant_new_nil(&st_4);
    if (p_num_args > 2)
        api10->godot_variant_new_copy(&st_5, p_args[2]);
    if (p_num_args > 1)
        api10->godot_variant_new_copy(&st_6, p_args[1]);
    if (p_num_args > 0)
        api10->godot_variant_new_copy(&st_7, p_args[0]);
    goto _0;
_0:
    goto _2;
_2:
...
_3:
    api11->godot_variant_evaluate(8, &st_7, &Class_1_test_parameter_copy_defs_with_defarg_local_const[1], &st_4, &__flag);
    api10->godot_variant_new_copy(&st_7, &st_4);
    api10->godot_variant_new_copy(&__return_value, &st_7);
    goto _2147483646;
    goto _2147483646;
_2147483646:
    ...
    goto _cleanup;
_24:
    api10->godot_variant_new_copy(&st_6, &Class_1_test_parameter_copy_defs_with_defarg_local_const[1]);
    goto _14;
_14:
    api10->godot_variant_new_copy(&st_5, &Class_1_test_parameter_copy_defs_with_defarg_local_const[2]);
    goto _3;
_19:
    api10->godot_variant_new_copy(&st_7, &Class_1_test_parameter_copy_defs_with_defarg_local_const[0]);
    goto _24;
_cleanup:
    //printf("Exit: Class_1_test_parameter_copy_defs_with_defarg_func\n");
    return __return_value;
}
void Class_1_vtable_init()
{
    ...
    VTABLE_METHOD(Class_1_vtable, 1, "test_parameter_copy_uses", Class_1_test_parameter_copy_uses_func, (void *)0);
    VTABLE_METHOD(Class_1_vtable, 2, "test_parameter_copy_defs", Class_1_test_parameter_copy_defs_func, (void *)0);
    VTABLE_METHOD(Class_1_vtable, 3, "test_parameter_copy_uses_with_defarg", Class_1_test_parameter_copy_uses_with_defarg_func, (void *)0);
    VTABLE_METHOD(Class_1_vtable, 4, "test_parameter_copy_defs_with_defarg", Class_1_test_parameter_copy_defs_with_defarg_func, (void *)0);
}
...
void GDN_EXPORT godot_gdnative_terminate(godot_gdnative_terminate_options *p_options)
{
    ...
    if (0 != Class_1_test_parameter_copy_defs_local_const_initialized)
    {
        api10->godot_variant_destroy(&Class_1_test_parameter_copy_defs_local_const[0]);
    }
    if (0 != Class_1_test_parameter_copy_uses_with_defarg_local_const_initialized)
    {
        api10->godot_variant_destroy(&Class_1_test_parameter_copy_uses_with_defarg_local_const[0]);
    }
    if (0 != Class_1_test_parameter_copy_defs_with_defarg_local_const_initialized)
    {
        api10->godot_variant_destroy(&Class_1_test_parameter_copy_defs_with_defarg_local_const[0]);
        api10->godot_variant_destroy(&Class_1_test_parameter_copy_defs_with_defarg_local_const[1]);
        api10->godot_variant_destroy(&Class_1_test_parameter_copy_defs_with_defarg_local_const[2]);
    }
...
void GDN_EXPORT godot_nativescript_init(void *p_handle)
{
    ...
    {
        //printf("  Register method: Class_1_test_parameter_copy_uses_func\n");
        godot_instance_method method = {NULL, NULL, NULL};
        method.method = &Class_1_test_parameter_copy_uses_func;
        godot_method_attributes attributes = {GODOT_METHOD_RPC_MODE_DISABLED};
        nativescript10->godot_nativescript_register_method(p_handle, "Class_1", "test_parameter_copy_uses", attributes, method);
    }
    {
        //printf("  Register method: Class_1_test_parameter_copy_defs_func\n");
        godot_instance_method method = {NULL, NULL, NULL};
        method.method = &Class_1_test_parameter_copy_defs_func;
        godot_method_attributes attributes = {GODOT_METHOD_RPC_MODE_DISABLED};
        nativescript10->godot_nativescript_register_method(p_handle, "Class_1", "test_parameter_copy_defs", attributes, method);
    }
    {
        //printf("  Register method: Class_1_test_parameter_copy_uses_with_defarg_func\n");
        godot_instance_method method = {NULL, NULL, NULL};
        method.method = &Class_1_test_parameter_copy_uses_with_defarg_func;
        godot_method_attributes attributes = {GODOT_METHOD_RPC_MODE_DISABLED};
        nativescript10->godot_nativescript_register_method(p_handle, "Class_1", "test_parameter_copy_uses_with_defarg", attributes, method);
    }
    {
        //printf("  Register method: Class_1_test_parameter_copy_defs_with_defarg_func\n");
        godot_instance_method method = {NULL, NULL, NULL};
        method.method = &Class_1_test_parameter_copy_defs_with_defarg_func;
        godot_method_attributes attributes = {GODOT_METHOD_RPC_MODE_DISABLED};
        nativescript10->godot_nativescript_register_method(p_handle, "Class_1", "test_parameter_copy_defs_with_defarg", attributes, method);
    }
    Class_1_vtable_init();
    ...
    api10->godot_variant_new_real(&global_hard_coded_constants_array[3], NAN);
    {
        ...
        register_classdb_global(&global_classdb_array[0], (const char *)data, 9);
    }
    {
        // ResourceFormatSaver
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[2], (const char *)data, 8);
    }
    {
        // Script
        char data[] = {83, 99, 114, 105, 112, 116};
        register_classdb_global(&global_classdb_array[3], (const char *)data, 6);
    }
    {
        // WeakRef
        char data[] = {87, 101, 97, 107, 82, 101, 102};
        register_classdb_global(&global_classdb_array[4], (const char *)data, 7);
    }
    {
        // Image
        char data[] = {73, 109, 97, 103, 101};
        register_classdb_global(&global_classdb_array[5], (const char *)data, 5);
    }
    {
        // StreamPeer
        char data[] = {83, 116, 114, 101, 97, 109, 80, 101, 101, 114};
        register_classdb_global(&global_classdb_array[6], (const char *)data, 10);
    }
    {
        // StreamPeerBuffer
        char data[] = {83, 116, 114, 101, 97, 109, 80, 101, 101, 114, 66, 117, 102, 102, 101, 114};
        register_classdb_global(&global_classdb_array[7], (const char *)data, 16);
    }
    {
        // StreamPeerTCP
        char data[] = {83, 116, 114, 101, 97, 109, 80, 101, 101, 114, 84, 67, 80};
        register_classdb_global(&global_classdb_array[8], (const char *)data, 13);
    }
    {
        // MultiplayerAPI
        char data[] = {77, 117, 108, 116, 105, 112, 108, 97, 121, 101, 114, 65, 80, 73};
        register_classdb_global(&global_classdb_array[9], (const char *)data, 14);
    }
    {
        // MainLoop
        char data[] = {77, 97, 105, 110, 76, 111, 111, 112};
        register_classdb_global(&global_classdb_array[10], (const char *)data, 8);
    }
    {
        // Translation
        char data[] = {84, 114, 97, 110, 115, 108, 97, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[11], (const char *)data, 11);
    }
    {
        // PHashTranslation
        char data[] = {80, 72, 97, 115, 104, 84, 114, 97, 110, 115, 108, 97, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[12], (const char *)data, 16);
    }
    {
        // UndoRedo
        char data[] = {85, 110, 100, 111, 82, 101, 100, 111};
        register_classdb_global(&global_classdb_array[13], (const char *)data, 8);
    }
    {
        // HTTPClient
        char data[] = {72, 84, 84, 80, 67, 108, 105, 101, 110, 116};
        register_classdb_global(&global_classdb_array[14], (const char *)data, 10);
    }
    {
        // _Directory
        char data[] = {95, 68, 105, 114, 101, 99, 116, 111, 114, 121};
        register_classdb_global(&global_classdb_array[15], (const char *)data, 10);
    }
    {
        // _Thread
        char data[] = {95, 84, 104, 114, 101, 97, 100};
        register_classdb_global(&global_classdb_array[16], (const char *)data, 7);
    }
    {
        // _Mutex
        char data[] = {95, 77, 117, 116, 101, 120};
        register_classdb_global(&global_classdb_array[17], (const char *)data, 6);
    }
    {
        // _Semaphore
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[19], (const char *)data, 9);
    }
    {
        // ConfigFile
        char data[] = {67, 111, 110, 102, 105, 103, 70, 105, 108, 101};
        register_classdb_global(&global_classdb_array[20], (const char *)data, 10);
    }
    {
        // IP_Unix
        char data[] = {73, 80, 95, 85, 110, 105, 120};
        register_classdb_global(&global_classdb_array[21], (const char *)data, 7);
    }
    {
        // _ClassDB
        char data[] = {95, 67, 108, 97, 115, 115, 68, 66};
        register_classdb_global(&global_classdb_array[22], (const char *)data, 8);
    }
    {
        // _Marshalls
        char data[] = {95, 77, 97, 114, 115, 104, 97, 108, 108, 115};
        register_classdb_global(&global_classdb_array[23], (const char *)data, 10);
    }
    {
        // _JSON
        char data[] = {95, 74, 83, 79, 78};
        register_classdb_global(&global_classdb_array[24], (const char *)data, 5);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[40], (const char *)data, 20);
    }
    {
        // InputEventMIDI
        char data[] = {73, 110, 112, 117, 116, 69, 118, 101, 110, 116, 77, 73, 68, 73};
        register_classdb_global(&global_classdb_array[41], (const char *)data, 14);
    }
    {
        // FuncRef
        char data[] = {70, 117, 110, 99, 82, 101, 102};
        register_classdb_global(&global_classdb_array[42], (const char *)data, 7);
    }
    {
        // TCP_Server
        char data[] = {84, 67, 80, 95, 83, 101, 114, 118, 101, 114};
        register_classdb_global(&global_classdb_array[43], (const char *)data, 10);
    }
    {
        // PacketPeer
        char data[] = {80, 97, 99, 107, 101, 116, 80, 101, 101, 114};
        register_classdb_global(&global_classdb_array[44], (const char *)data, 10);
    }
    {
        // PacketPeerUDP
        char data[] = {80, 97, 99, 107, 101, 116, 80, 101, 101, 114, 85, 68, 80};
        register_classdb_global(&global_classdb_array[45], (const char *)data, 13);
    }
    {
        // HashingContext
        char data[] = {72, 97, 115, 104, 105, 110, 103, 67, 111, 110, 116, 101, 120, 116};
        register_classdb_global(&global_classdb_array[46], (const char *)data, 14);
    }
    {
        // X509Certificate
        char data[] = {88, 53, 48, 57, 67, 101, 114, 116, 105, 102, 105, 99, 97, 116, 101};
        register_classdb_global(&global_classdb_array[47], (const char *)data, 15);
    }
    {
        // CryptoKey
        char data[] = {67, 114, 121, 112, 116, 111, 75, 101, 121};
        register_classdb_global(&global_classdb_array[48], (const char *)data, 9);
    }
    {
        // Crypto
        char data[] = {67, 114, 121, 112, 116, 111};
        register_classdb_global(&global_classdb_array[49], (const char *)data, 6);
    }
    {
        // StreamPeerSSL
        char data[] = {83, 116, 114, 101, 97, 109, 80, 101, 101, 114, 83, 83, 76};
        register_classdb_global(&global_classdb_array[50], (const char *)data, 13);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[51], (const char *)data, 25);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[52], (const char *)data, 26);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[53], (const char *)data, 16);
    }
    {
        // NetworkedMultiplayerPeer
        char data[] = {78, 101, 116, 119, 111, 114, 107, 101, 100, 77, 117, 108, 116, 105, 112, 108, 97, 121, 101, 114, 80, 101, 101, 114};
        register_classdb_global(&global_classdb_array[54], (const char *)data, 24);
    }
    {
        // TriangleMesh
        char data[] = {84, 114, 105, 97, 110, 103, 108, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[55], (const char *)data, 12);
    }
    {
        // ResourceInteractiveLoader
        char data[] = {82, 101, 115, 111, 117, 114, 99, 101, 73, 110, 116, 101, 114, 97, 99, 116, 105, 118, 101, 76, 111, 97, 100, 101, 114};
        register_classdb_global(&global_classdb_array[56], (const char *)data, 25);
    }
    {
        // _File
        char data[] = {95, 70, 105, 108, 101};
        register_classdb_global(&global_classdb_array[57], (const char *)data, 5);
    }
    {
        // PCKPacker
        char data[] = {80, 67, 75, 80, 97, 99, 107, 101, 114};
        register_classdb_global(&global_classdb_array[58], (const char *)data, 9);
    }
    {
        // PackedDataContainer
        char data[] = {80, 97, 99, 107, 101, 100, 68, 97, 116, 97, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[59], (const char *)data, 19);
    }
    {
        // PackedDataContainerRef
        char data[] = {80, 97, 99, 107, 101, 100, 68, 97, 116, 97, 67, 111, 110, 116, 97, 105, 110, 101, 114, 82, 101, 102};
        register_classdb_global(&global_classdb_array[60], (const char *)data, 22);
    }
    {
        // AStar
        char data[] = {65, 83, 116, 97, 114};
        register_classdb_global(&global_classdb_array[61], (const char *)data, 5);
    }
    {
        // AStar2D
        char data[] = {65, 83, 116, 97, 114, 50, 68};
        register_classdb_global(&global_classdb_array[62], (const char *)data, 7);
    }
    {
        // EncodedObjectAsID
        char data[] = {69, 110, 99, 111, 100, 101, 100, 79, 98, 106, 101, 99, 116, 65, 115, 73, 68};
        register_classdb_global(&global_classdb_array[63], (const char *)data, 17);
    }
    {
        // RandomNumberGenerator
        char data[] = {82, 97, 110, 100, 111, 109, 78, 117, 109, 98, 101, 114, 71, 101, 110, 101, 114, 97, 116, 111, 114};
        register_classdb_global(&global_classdb_array[64], (const char *)data, 21);
    }
    {
        // JSONParseResult
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[66], (const char *)data, 16);
    }
    {
        // _Geometry
        char data[] = {95, 71, 101, 111, 109, 101, 116, 114, 121};
        register_classdb_global(&global_classdb_array[67], (const char *)data, 9);
    }
    {
        // _ResourceLoader
        char data[] = {95, 82, 101, 115, 111, 117, 114, 99, 101, 76, 111, 97, 100, 101, 114};
        register_classdb_global(&global_classdb_array[68], (const char *)data, 15);
    }
    {
        // _ResourceSaver
        char data[] = {95, 82, 101, 115, 111, 117, 114, 99, 101, 83, 97, 118, 101, 114};
        register_classdb_global(&global_classdb_array[69], (const char *)data, 14);
    }
    {
        // _OS
        char data[] = {95, 79, 83};
        register_classdb_global(&global_classdb_array[70], (const char *)data, 3);
    }
    {
        // _Engine
        char data[] = {95, 69, 110, 103, 105, 110, 101};
        register_classdb_global(&global_classdb_array[71], (const char *)data, 7);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[99], (const char *)data, 21);
    }
    {
        // AudioEffectStereoEnhance
        char data[] = {65, 117, 100, 105, 111, 69, 102, 102, 101, 99, 116, 83, 116, 101, 114, 101, 111, 69, 110, 104, 97, 110, 99, 101};
        register_classdb_global(&global_classdb_array[100], (const char *)data, 24);
    }
    {
        // AudioEffectPanner
        char data[] = {65, 117, 100, 105, 111, 69, 102, 102, 101, 99, 116, 80, 97, 110, 110, 101, 114};
        register_classdb_global(&global_classdb_array[101], (const char *)data, 17);
    }
    {
        // AudioEffectChorus
        char data[] = {65, 117, 100, 105, 111, 69, 102, 102, 101, 99, 116, 67, 104, 111, 114, 117, 115};
        register_classdb_global(&global_classdb_array[102], (const char *)data, 17);
    }
    {
        // AudioEffectDelay
        char data[] = {65, 117, 100, 105, 111, 69, 102, 102, 101, 99, 116, 68, 101, 108, 97, 121};
        register_classdb_global(&global_classdb_array[103], (const char *)data, 16);
    }
    {
        // Node
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[105], (const char *)data, 19);
    }
    {
        // Texture
        char data[] = {84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[106], (const char *)data, 7);
    }
    {
        // ViewportTexture
        char data[] = {86, 105, 101, 119, 112, 111, 114, 116, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[107], (const char *)data, 15);
    }
    {
        // Timer
        char data[] = {84, 105, 109, 101, 114};
        register_classdb_global(&global_classdb_array[108], (const char *)data, 5);
    }
    {
        // BaseButton
        char data[] = {66, 97, 115, 101, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[109], (const char *)data, 10);
    }
    {
        // ShortCut
        char data[] = {83, 104, 111, 114, 116, 67, 117, 116};
        register_classdb_global(&global_classdb_array[110], (const char *)data, 8);
    }
    {
        // Range
        char data[] = {82, 97, 110, 103, 101};
        register_classdb_global(&global_classdb_array[111], (const char *)data, 5);
    }
    {
        // PopupPanel
        char data[] = {80, 111, 112, 117, 112, 80, 97, 110, 101, 108};
        register_classdb_global(&global_classdb_array[112], (const char *)data, 10);
    }
    {
        // MenuButton
        char data[] = {77, 101, 110, 117, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[113], (const char *)data, 10);
    }
    {
        // CheckBox
        char data[] = {67, 104, 101, 99, 107, 66, 111, 120};
        register_classdb_global(&global_classdb_array[114], (const char *)data, 8);
    }
    {
        // CheckButton
        char data[] = {67, 104, 101, 99, 107, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[115], (const char *)data, 11);
    }
    {
        // ToolButton
        char data[] = {84, 111, 111, 108, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[116], (const char *)data, 10);
    }
    {
        // LinkButton
        char data[] = {76, 105, 110, 107, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[117], (const char *)data, 10);
    }
    {
        // Panel
        char data[] = {80, 97, 110, 101, 108};
        register_classdb_global(&global_classdb_array[118], (const char *)data, 5);
    }
    {
        // TextureRect
        char data[] = {84, 101, 120, 116, 117, 114, 101, 82, 101, 99, 116};
        register_classdb_global(&global_classdb_array[119], (const char *)data, 11);
    }
    {
        // ColorRect
        char data[] = {67, 111, 108, 111, 114, 82, 101, 99, 116};
        register_classdb_global(&global_classdb_array[120], (const char *)data, 9);
    }
    {
        // NinePatchRect
        char data[] = {78, 105, 110, 101, 80, 97, 116, 99, 104, 82, 101, 99, 116};
        register_classdb_global(&global_classdb_array[121], (const char *)data, 13);
    }
    {
        // ReferenceRect
        char data[] = {82, 101, 102, 101, 114, 101, 110, 99, 101, 82, 101, 99, 116};
        register_classdb_global(&global_classdb_array[122], (const char *)data, 13);
    }
    {
        // Container
        char data[] = {67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[123], (const char *)data, 9);
    }
    {
        // TabContainer
        char data[] = {84, 97, 98, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[124], (const char *)data, 12);
    }
    {
        // Tabs
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[126], (const char *)data, 9);
    }
    {
        // HSeparator
        char data[] = {72, 83, 101, 112, 97, 114, 97, 116, 111, 114};
        register_classdb_global(&global_classdb_array[127], (const char *)data, 10);
    }
    {
        // VSeparator
        char data[] = {86, 83, 101, 112, 97, 114, 97, 116, 111, 114};
        register_classdb_global(&global_classdb_array[128], (const char *)data, 10);
    }
    {
        // TextureButton
        char data[] = {84, 101, 120, 116, 117, 114, 101, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[129], (const char *)data, 13);
    }
    {
        // CenterContainer
        char data[] = {67, 101, 110, 116, 101, 114, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[130], (const char *)data, 15);
    }
    {
        // ScrollContainer
        char data[] = {83, 99, 114, 111, 108, 108, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[131], (const char *)data, 15);
    }
    {
        // PanelContainer
        char data[] = {80, 97, 110, 101, 108, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[132], (const char *)data, 14);
    }
    {
        // TextureProgress
        char data[] = {84, 101, 120, 116, 117, 114, 101, 80, 114, 111, 103, 114, 101, 115, 115};
        register_classdb_global(&global_classdb_array[133], (const char *)data, 15);
    }
    {
        // InputDefault
        char data[] = {73, 110, 112, 117, 116, 68, 101, 102, 97, 117, 108, 116};
        register_classdb_global(&global_classdb_array[134], (const char *)data, 12);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[141], (const char *)data, 35);
    }
    {
        // CameraFeed
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[155], (const char *)data, 11);
    }
    {
        // CanvasLayer
        char data[] = {67, 97, 110, 118, 97, 115, 76, 97, 121, 101, 114};
        register_classdb_global(&global_classdb_array[156], (const char *)data, 11);
    }
    {
        // CanvasItem
        char data[] = {67, 97, 110, 118, 97, 115, 73, 116, 101, 109};
        register_classdb_global(&global_classdb_array[157], (const char *)data, 10);
    }
    {
        // Node2D
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[160], (const char *)data, 17);
    }
    {
        // ButtonGroup
        char data[] = {66, 117, 116, 116, 111, 110, 71, 114, 111, 117, 112};
        register_classdb_global(&global_classdb_array[161], (const char *)data, 11);
    }
    {
        // Control
        char data[] = {67, 111, 110, 116, 114, 111, 108};
        register_classdb_global(&global_classdb_array[162], (const char *)data, 7);
    }
    {
        // Theme
        char data[] = {84, 104, 101, 109, 101};
        register_classdb_global(&global_classdb_array[163], (const char *)data, 5);
    }
    {
        // Button
        char data[] = {66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[164], (const char *)data, 6);
    }
    {
        // Label
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[166], (const char *)data, 9);
    }
    {
        // HScrollBar
        char data[] = {72, 83, 99, 114, 111, 108, 108, 66, 97, 114};
        register_classdb_global(&global_classdb_array[167], (const char *)data, 10);
    }
    {
        // VScrollBar
        char data[] = {86, 83, 99, 114, 111, 108, 108, 66, 97, 114};
        register_classdb_global(&global_classdb_array[168], (const char *)data, 10);
    }
    {
        // ProgressBar
        char data[] = {80, 114, 111, 103, 114, 101, 115, 115, 66, 97, 114};
        register_classdb_global(&global_classdb_array[169], (const char *)data, 11);
    }
    {
        // Slider
        char data[] = {83, 108, 105, 100, 101, 114};
        register_classdb_global(&global_classdb_array[170], (const char *)data, 6);
    }
    {
        // HSlider
        char data[] = {72, 83, 108, 105, 100, 101, 114};
        register_classdb_global(&global_classdb_array[171], (const char *)data, 7);
    }
    {
        // VSlider
        char data[] = {86, 83, 108, 105, 100, 101, 114};
        register_classdb_global(&global_classdb_array[172], (const char *)data, 7);
    }
    {
        // Popup
        char data[] = {80, 111, 112, 117, 112};
        register_classdb_global(&global_classdb_array[173], (const char *)data, 5);
    }
    {
        // BitMap
        char data[] = {66, 105, 116, 77, 97, 112};
        register_classdb_global(&global_classdb_array[174], (const char *)data, 6);
    }
    {
        // BoxContainer
        char data[] = {66, 111, 120, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[175], (const char *)data, 12);
    }
    {
        // HBoxContainer
        char data[] = {72, 66, 111, 120, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[176], (const char *)data, 13);
    }
    {
        // VBoxContainer
        char data[] = {86, 66, 111, 120, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[177], (const char *)data, 13);
    }
    {
        // GridContainer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[179], (const char *)data, 8);
    }
    {
        // VideoPlayer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[181], (const char *)data, 11);
    }
    {
        // WindowDialog
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[183], (const char *)data, 12);
    }
    {
        // ConfirmationDialog
        char data[] = {67, 111, 110, 102, 105, 114, 109, 97, 116, 105, 111, 110, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[184], (const char *)data, 18);
    }
    {
        // FileDialog
        char data[] = {70, 105, 108, 101, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[185], (const char *)data, 10);
    }
    {
        // PopupMenu
        char data[] = {80, 111, 112, 117, 112, 77, 101, 110, 117};
        register_classdb_global(&global_classdb_array[186], (const char *)data, 9);
    }
    {
        // Tree
        char data[] = {84, 114, 101, 101};
        register_classdb_global(&global_classdb_array[187], (const char *)data, 4);
    }
    {
        // TreeItem
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[189], (const char *)data, 8);
    }
    {
        // CharFXTransform
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[191], (const char *)data, 14);
    }
    {
        // ItemList
        char data[] = {73, 116, 101, 109, 76, 105, 115, 116};
        register_classdb_global(&global_classdb_array[192], (const char *)data, 8);
    }
    {
        // OptionButton
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[194], (const char *)data, 7);
    }
    {
        // ColorPicker
        char data[] = {67, 111, 108, 111, 114, 80, 105, 99, 107, 101, 114};
        register_classdb_global(&global_classdb_array[195], (const char *)data, 11);
    }
    {
        // ColorPickerButton
        char data[] = {67, 111, 108, 111, 114, 80, 105, 99, 107, 101, 114, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[196], (const char *)data, 17);
    }
    {
        // RichTextLabel
        char data[] = {82, 105, 99, 104, 84, 101, 120, 116, 76, 97, 98, 101, 108};
        register_classdb_global(&global_classdb_array[197], (const char *)data, 13);
    }
    {
        // GraphEdit
        char data[] = {71, 114, 97, 112, 104, 69, 100, 105, 116};
        register_classdb_global(&global_classdb_array[198], (const char *)data, 9);
    }
    {
        // SkinReference
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[200], (const char *)data, 7);
    }
    {
        // SpatialGizmo
        char data[] = {83, 112, 97, 116, 105, 97, 108, 71, 105, 122, 109, 111};
        register_classdb_global(&global_classdb_array[201], (const char *)data, 12);
    }
    {
        // Skeleton
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[203], (const char *)data, 15);
    }
    {
        // Tween
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[207], (const char *)data, 13);
    }
    {
        // Listener
        char data[] = {76, 105, 115, 116, 101, 110, 101, 114};
        register_classdb_global(&global_classdb_array[208], (const char *)data, 8);
    }
    {
        // ARVRCamera
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[210], (const char *)data, 14);
    }
    {
        // Mesh
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[212], (const char *)data, 10);
    }
    {
        // ARVROrigin
        char data[] = {65, 82, 86, 82, 79, 114, 105, 103, 105, 110};
        register_classdb_global(&global_classdb_array[213], (const char *)data, 10);
    }
    {
        // InterpolatedCamera
        char data[] = {73, 110, 116, 101, 114, 112, 111, 108, 97, 116, 101, 100, 67, 97, 109, 101, 114, 97};
        register_classdb_global(&global_classdb_array[214], (const char *)data, 18);
    }
    {
        // MeshInstance
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[216], (const char *)data, 17);
    }
    {
        // Sprite3D
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[218], (const char *)data, 16);
    }
    {
        // SpriteFrames
        char data[] = {83, 112, 114, 105, 116, 101, 70, 114, 97, 109, 101, 115};
        register_classdb_global(&global_classdb_array[219], (const char *)data, 12);
    }
    {
        // Light
        char data[] = {76, 105, 103, 104, 116};
        register_classdb_global(&global_classdb_array[220], (const char *)data, 5);
    }
    {
        // GIProbeData
        char data[] = {71, 73, 80, 114, 111, 98, 101, 68, 97, 116, 97};
        register_classdb_global(&global_classdb_array[221], (const char *)data, 11);
    }
    {
        // BakedLightmap
        char data[] = {66, 97, 107, 101, 100, 76, 105, 103, 104, 116, 109, 97, 112};
        register_classdb_global(&global_classdb_array[222], (const char *)data, 13);
    }
    {
        // AnimationRootNode
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 82, 111, 111, 116, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[223], (const char *)data, 17);
    }
    {
        // AnimationNode
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[224], (const char *)data, 13);
    }
    {
        // AnimationNodeBlendTree
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 66, 108, 101, 110, 100, 84, 114, 101, 101};
        register_classdb_global(&global_classdb_array[225], (const char *)data, 22);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[226], (const char *)data, 33);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[227], (const char *)data, 35);
    }
    {
        // AnimationNodeOutput
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 79, 117, 116, 112, 117, 116};
        register_classdb_global(&global_classdb_array[228], (const char *)data, 19);
    }
    {
        // AnimationNodeOneShot
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 79, 110, 101, 83, 104, 111, 116};
        register_classdb_global(&global_classdb_array[229], (const char *)data, 20);
    }
    {
        // StaticBody
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[238], (const char *)data, 31);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[240], (const char *)data, 28);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[249], (const char *)data, 29);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[250], (const char *)data, 36);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[251], (const char *)data, 36);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[253], (const char *)data, 8);
    }
    {
        // Particles2D
        char data[] = {80, 97, 114, 116, 105, 99, 108, 101, 115, 50, 68};
        register_classdb_global(&global_classdb_array[254], (const char *)data, 11);
    }
    {
        // AnimatedSprite
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[257], (const char *)data, 12);
    }
    {
        // RigidBody2D
        char data[] = {82, 105, 103, 105, 100, 66, 111, 100, 121, 50, 68};
        register_classdb_global(&global_classdb_array[258], (const char *)data, 11);
    }
    {
        // KinematicCollision2D
        char data[] = {75, 105, 110, 101, 109, 97, 116, 105, 99, 67, 111, 108, 108, 105, 115, 105, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[259], (const char *)data, 20);
    }
    {
        // Area2D
        char data[] = {65, 114, 101, 97, 50, 68};
        register_classdb_global(&global_classdb_array[260], (const char *)data, 6);
    }
    {
        // CollisionShape2D
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[261], (const char *)data, 16);
    }
    {
        // Skeleton2D
        char data[] = {83, 107, 101, 108, 101, 116, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[262], (const char *)data, 10);
    }
    {
        // Bone2D
        char data[] = {66, 111, 110, 101, 50, 68};
        register_classdb_global(&global_classdb_array[263], (const char *)data, 6);
    }
    {
        // Light2D
        char data[] = {76, 105, 103, 104, 116, 50, 68};
        register_classdb_global(&global_classdb_array[264], (const char *)data, 7);
    }
    {
        // Camera2D
        char data[] = {67, 97, 109, 101, 114, 97, 50, 68};
        register_classdb_global(&global_classdb_array[265], (const char *)data, 8);
    }
    {
        // ParallaxBackground
        char data[] = {80, 97, 114, 97, 108, 108, 97, 120, 66, 97, 99, 107, 103, 114, 111, 117, 110, 100};
        register_classdb_global(&global_classdb_array[266], (const char *)data, 18);
    }
    {
        // RemoteTransform2D
        char data[] = {82, 101, 109, 111, 116, 101, 84, 114, 97, 110, 115, 102, 111, 114, 109, 50, 68};
        register_classdb_global(&global_classdb_array[267], (const char *)data, 17);
    }
    {
        // ParallaxLayer
        char data[] = {80, 97, 114, 97, 108, 108, 97, 120, 76, 97, 121, 101, 114};
        register_classdb_global(&global_classdb_array[268], (const char *)data, 13);
    }
    {
        // ParticlesMaterial
        char data[] = {80, 97, 114, 116, 105, 99, 108, 101, 115, 77, 97, 116, 101, 114, 105, 97, 108};
        register_classdb_global(&global_classdb_array[269], (const char *)data, 17);
    }
    {
        // SphereShape
        char data[] = {83, 112, 104, 101, 114, 101, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[270], (const char *)data, 11);
    }
    {
        // BoxShape
        char data[] = {66, 111, 120, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[271], (const char *)data, 8);
    }
    {
        // CapsuleShape
        char data[] = {67, 97, 112, 115, 117, 108, 101, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[272], (const char *)data, 12);
    }
    {
        // CylinderShape
        char data[] = {67, 121, 108, 105, 110, 100, 101, 114, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[273], (const char *)data, 13);
    }
    {
        // HeightMapShape
        char data[] = {72, 101, 105, 103, 104, 116, 77, 97, 112, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[274], (const char *)data, 14);
    }
    {
        // PlaneShape
        char data[] = {80, 108, 97, 110, 101, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[275], (const char *)data, 10);
    }
    {
        // ConvexPolygonShape
        char data[] = {67, 111, 110, 118, 101, 120, 80, 111, 108, 121, 103, 111, 110, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[276], (const char *)data, 18);
    }
    {
        // ConcavePolygonShape
        char data[] = {67, 111, 110, 99, 97, 118, 101, 80, 111, 108, 121, 103, 111, 110, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[277], (const char *)data, 19);
    }
    {
        // SpatialVelocityTracker
        char data[] = {83, 112, 97, 116, 105, 97, 108, 86, 101, 108, 111, 99, 105, 116, 121, 84, 114, 97, 99, 107, 101, 114};
        register_classdb_global(&global_classdb_array[278], (const char *)data, 22);
    }
    {
        // ProxyTexture
        char data[] = {80, 114, 111, 120, 121, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[279], (const char *)data, 12);
    }
    {
        // AnimatedTexture
        char data[] = {65, 110, 105, 109, 97, 116, 101, 100, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[280], (const char *)data, 15);
    }
    {
        // CameraTexture
        char data[] = {67, 97, 109, 101, 114, 97, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[281], (const char *)data, 13);
    }
    {
        // TextFile
        char data[] = {84, 101, 120, 116, 70, 105, 108, 101};
        register_classdb_global(&global_classdb_array[282], (const char *)data, 8);
    }
    {
        // DynamicFontData
        char data[] = {68, 121, 110, 97, 109, 105, 99, 70, 111, 110, 116, 68, 97, 116, 97};
        register_classdb_global(&global_classdb_array[283], (const char *)data, 15);
    }
    {
        // StyleBox
        char data[] = {83, 116, 121, 108, 101, 66, 111, 120};
        register_classdb_global(&global_classdb_array[284], (const char *)data, 8);
    }
    {
        // PopupDialog
        char data[] = {80, 111, 112, 117, 112, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[285], (const char *)data, 11);
    }
    {
        // MarginContainer
        char data[] = {77, 97, 114, 103, 105, 110, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[286], (const char *)data, 15);
    }
    {
        // ViewportContainer
        char data[] = {86, 105, 101, 119, 112, 111, 114, 116, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[287], (const char *)data, 17);
    }
    {
        // SplitContainer
        char data[] = {83, 112, 108, 105, 116, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[288], (const char *)data, 14);
    }
    {
        // HSplitContainer
        char data[] = {72, 83, 112, 108, 105, 116, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[289], (const char *)data, 15);
    }
    {
        // VSplitContainer
        char data[] = {86, 83, 112, 108, 105, 116, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[290], (const char *)data, 15);
    }
    {
        // GraphNode
        char data[] = {71, 114, 97, 112, 104, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[291], (const char *)data, 9);
    }
    {
        // Skin
        char data[] = {83, 107, 105, 110};
        register_classdb_global(&global_classdb_array[292], (const char *)data, 4);
    }
    {
        // VisualInstance
        char data[] = {86, 105, 115, 117, 97, 108, 73, 110, 115, 116, 97, 110, 99, 101};
        register_classdb_global(&global_classdb_array[293], (const char *)data, 14);
    }
    {
        // Camera
        char data[] = {67, 97, 109, 101, 114, 97};
        register_classdb_global(&global_classdb_array[294], (const char *)data, 6);
    }
    {
        // SpriteBase3D
        char data[] = {83, 112, 114, 105, 116, 101, 66, 97, 115, 101, 51, 68};
        register_classdb_global(&global_classdb_array[295], (const char *)data, 12);
    }
    {
        // DirectionalLight
        char data[] = {68, 105, 114, 101, 99, 116, 105, 111, 110, 97, 108, 76, 105, 103, 104, 116};
        register_classdb_global(&global_classdb_array[296], (const char *)data, 16);
    }
    {
        // OmniLight
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[298], (const char *)data, 9);
    }
    {
        // ReflectionProbe
        char data[] = {82, 101, 102, 108, 101, 99, 116, 105, 111, 110, 80, 114, 111, 98, 101};
        register_classdb_global(&global_classdb_array[299], (const char *)data, 15);
    }
    {
        // GIProbe
        char data[] = {71, 73, 80, 114, 111, 98, 101};
        register_classdb_global(&global_classdb_array[300], (const char *)data, 7);
    }
    {
        // BakedLightmapData
        char data[] = {66, 97, 107, 101, 100, 76, 105, 103, 104, 116, 109, 97, 112, 68, 97, 116, 97};
        register_classdb_global(&global_classdb_array[301], (const char *)data, 17);
    }
    {
        // AnimationTreePlayer
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 84, 114, 101, 101, 80, 108, 97, 121, 101, 114};
        register_classdb_global(&global_classdb_array[302], (const char *)data, 19);
    }
    {
        // Particles
        char data[] = {80, 97, 114, 116, 105, 99, 108, 101, 115};
        register_classdb_global(&global_classdb_array[303], (const char *)data, 9);
    }
    {
        // CPUParticles
        char data[] = {67, 80, 85, 80, 97, 114, 116, 105, 99, 108, 101, 115};
        register_classdb_global(&global_classdb_array[304], (const char *)data, 12);
    }
    {
        // Curve
        char data[] = {67, 117, 114, 118, 101};
        register_classdb_global(&global_classdb_array[305], (const char *)data, 5);
    }
    {
        // Gradient
        char data[] = {71, 114, 97, 100, 105, 101, 110, 116};
        register_classdb_global(&global_classdb_array[306], (const char *)data, 8);
    }
    {
        // Position3D
        char data[] = {80, 111, 115, 105, 116, 105, 111, 110, 51, 68};
        register_classdb_global(&global_classdb_array[307], (const char *)data, 10);
    }
    {
        // NavigationMeshInstance
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110, 77, 101, 115, 104, 73, 110, 115, 116, 97, 110, 99, 101};
        register_classdb_global(&global_classdb_array[308], (const char *)data, 22);
    }
    {
        // NavigationMesh
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[309], (const char *)data, 14);
    }
    {
        // Navigation
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[310], (const char *)data, 10);
    }
    {
        // RootMotionView
        char data[] = {82, 111, 111, 116, 77, 111, 116, 105, 111, 110, 86, 105, 101, 119};
        register_classdb_global(&global_classdb_array[311], (const char *)data, 14);
    }
    {
        // AnimationTree
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 84, 114, 101, 101};
        register_classdb_global(&global_classdb_array[312], (const char *)data, 13);
    }
    {
        // AnimationNodeBlendSpace1D
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 66, 108, 101, 110, 100, 83, 112, 97, 99, 101, 49, 68};
        register_classdb_global(&global_classdb_array[313], (const char *)data, 25);
    }
    {
        // AnimationNodeBlendSpace2D
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 66, 108, 101, 110, 100, 83, 112, 97, 99, 101, 50, 68};
        register_classdb_global(&global_classdb_array[314], (const char *)data, 25);
    }
    {
        // AnimationNodeStateMachine
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 83, 116, 97, 116, 101, 77, 97, 99, 104, 105, 110, 101};
        register_classdb_global(&global_classdb_array[315], (const char *)data, 25);
    }
    {
        // AnimationNodeAnimation
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 65, 110, 105, 109, 97, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[316], (const char *)data, 22);
    }
    {
        // AnimationNodeAdd2
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 65, 100, 100, 50};
        register_classdb_global(&global_classdb_array[317], (const char *)data, 17);
    }
    {
        // AnimationNodeAdd3
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 65, 100, 100, 51};
        register_classdb_global(&global_classdb_array[318], (const char *)data, 17);
    }
    {
        // AnimationNodeBlend2
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 66, 108, 101, 110, 100, 50};
        register_classdb_global(&global_classdb_array[319], (const char *)data, 19);
    }
    {
        // AnimationNodeBlend3
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 66, 108, 101, 110, 100, 51};
        register_classdb_global(&global_classdb_array[320], (const char *)data, 19);
    }
    {
        // AnimationNodeTimeScale
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 84, 105, 109, 101, 83, 99, 97, 108, 101};
        register_classdb_global(&global_classdb_array[321], (const char *)data, 22);
    }
    {
        // AnimationNodeTimeSeek
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 84, 105, 109, 101, 83, 101, 101, 107};
        register_classdb_global(&global_classdb_array[322], (const char *)data, 21);
    }
    {
        // AnimationNodeTransition
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 84, 114, 97, 110, 115, 105, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[323], (const char *)data, 23);
    }
    {
        // CollisionObject
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 79, 98, 106, 101, 99, 116};
        register_classdb_global(&global_classdb_array[324], (const char *)data, 15);
    }
    {
        // PhysicsBody
        char data[] = {80, 104, 121, 115, 105, 99, 115, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[325], (const char *)data, 11);
    }
    {
        // KinematicCollision
        char data[] = {75, 105, 110, 101, 109, 97, 116, 105, 99, 67, 111, 108, 108, 105, 115, 105, 111, 110};
        register_classdb_global(&global_classdb_array[326], (const char *)data, 18);
    }
    {
        // KinematicBody
        char data[] = {75, 105, 110, 101, 109, 97, 116, 105, 99, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[327], (const char *)data, 13);
    }
    {
        // SpringArm
        char data[] = {83, 112, 114, 105, 110, 103, 65, 114, 109};
        register_classdb_global(&global_classdb_array[328], (const char *)data, 9);
    }
    {
        // Shape
        char data[] = {83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[329], (const char *)data, 5);
    }
    {
        // PhysicalBone
        char data[] = {80, 104, 121, 115, 105, 99, 97, 108, 66, 111, 110, 101};
        register_classdb_global(&global_classdb_array[330], (const char *)data, 12);
    }
    {
        // SoftBody
        char data[] = {83, 111, 102, 116, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[331], (const char *)data, 8);
    }
    {
        // SkeletonIK
        char data[] = {83, 107, 101, 108, 101, 116, 111, 110, 73, 75};
        register_classdb_global(&global_classdb_array[332], (const char *)data, 10);
    }
    {
        // BoneAttachment
        char data[] = {66, 111, 110, 101, 65, 116, 116, 97, 99, 104, 109, 101, 110, 116};
        register_classdb_global(&global_classdb_array[333], (const char *)data, 14);
    }
    {
        // VehicleBody
        char data[] = {86, 101, 104, 105, 99, 108, 101, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[334], (const char *)data, 11);
    }
    {
        // VehicleWheel
        char data[] = {86, 101, 104, 105, 99, 108, 101, 87, 104, 101, 101, 108};
        register_classdb_global(&global_classdb_array[335], (const char *)data, 12);
    }
    {
        // Area
        char data[] = {65, 114, 101, 97};
        register_classdb_global(&global_classdb_array[336], (const char *)data, 4);
    }
    {
        // ProximityGroup
        char data[] = {80, 114, 111, 120, 105, 109, 105, 116, 121, 71, 114, 111, 117, 112};
        register_classdb_global(&global_classdb_array[337], (const char *)data, 14);
    }
    {
        // CollisionShape
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[338], (const char *)data, 14);
    }
    {
        // CollisionPolygon
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 80, 111, 108, 121, 103, 111, 110};
        register_classdb_global(&global_classdb_array[339], (const char *)data, 16);
    }
    {
        // RayCast
        char data[] = {82, 97, 121, 67, 97, 115, 116};
        register_classdb_global(&global_classdb_array[340], (const char *)data, 7);
    }
    {
        // MultiMeshInstance
        char data[] = {77, 117, 108, 116, 105, 77, 101, 115, 104, 73, 110, 115, 116, 97, 110, 99, 101};
        register_classdb_global(&global_classdb_array[341], (const char *)data, 17);
    }
    {
        // MultiMesh
        char data[] = {77, 117, 108, 116, 105, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[342], (const char *)data, 9);
    }
    {
        // Curve3D
        char data[] = {67, 117, 114, 118, 101, 51, 68};
        register_classdb_global(&global_classdb_array[343], (const char *)data, 7);
    }
    {
        // Path
        char data[] = {80, 97, 116, 104};
        register_classdb_global(&global_classdb_array[344], (const char *)data, 4);
    }
    {
        // PathFollow
        char data[] = {80, 97, 116, 104, 70, 111, 108, 108, 111, 119};
        register_classdb_global(&global_classdb_array[345], (const char *)data, 10);
    }
    {
        // VisibilityNotifier
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[347], (const char *)data, 17);
    }
    {
        // WorldEnvironment
        char data[] = {87, 111, 114, 108, 100, 69, 110, 118, 105, 114, 111, 110, 109, 101, 110, 116};
        register_classdb_global(&global_classdb_array[348], (const char *)data, 16);
    }
    {
        // RemoteTransform
        char data[] = {82, 101, 109, 111, 116, 101, 84, 114, 97, 110, 115, 102, 111, 114, 109};
        register_classdb_global(&global_classdb_array[349], (const char *)data, 15);
    }
    {
        // Joint
        char data[] = {74, 111, 105, 110, 116};
        register_classdb_global(&global_classdb_array[350], (const char *)data, 5);
    }
    {
        // PinJoint
        char data[] = {80, 105, 110, 74, 111, 105, 110, 116};
        register_classdb_global(&global_classdb_array[351], (const char *)data, 8);
    }
    {
        // HingeJoint
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[353], (const char *)data, 11);
    }
    {
        // ConeTwistJoint
        char data[] = {67, 111, 110, 101, 84, 119, 105, 115, 116, 74, 111, 105, 110, 116};
        register_classdb_global(&global_classdb_array[354], (const char *)data, 14);
    }
    {
        // Generic6DOFJoint
        char data[] = {71, 101, 110, 101, 114, 105, 99, 54, 68, 79, 70, 74, 111, 105, 110, 116};
        register_classdb_global(&global_classdb_array[355], (const char *)data, 16);
    }
    {
        // Shader
        char data[] = {83, 104, 97, 100, 101, 114};
        register_classdb_global(&global_classdb_array[356], (const char *)data, 6);
    }
    {
        // VisualShaderNode
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[357], (const char *)data, 16);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[358], (const char *)data, 30);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[366], (const char *)data, 32);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[367], (const char *)data, 32);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[368], (const char *)data, 32);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[369], (const char *)data, 38);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[374], (const char *)data, 31);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[375], (const char *)data, 29);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[376], (const char *)data, 32);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[378], (const char *)data, 34);
    }
    {
        // VisualShaderNodeTexture
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[379], (const char *)data, 23);
    }
    {
        // VisualShaderNodeCubeMap
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 67, 117, 98, 101, 77, 97, 112};
        register_classdb_global(&global_classdb_array[380], (const char *)data, 23);
    }
    {
        // CubeMap
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[382], (const char *)data, 23);
    }
    {
        // VisualShaderNodeScalarUniform
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 83, 99, 97, 108, 97, 114, 85, 110, 105, 102, 111, 114, 109};
        register_classdb_global(&global_classdb_array[383], (const char *)data, 29);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[387], (const char *)data, 32);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[388], (const char *)data, 30);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[389], (const char *)data, 39);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[396], (const char *)data, 32);
    }
    {
        // VisualShaderNodeIs
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 73, 115};
        register_classdb_global(&global_classdb_array[397], (const char *)data, 18);
    }
    {
        // VisualShaderNodeCompare
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 67, 111, 109, 112, 97, 114, 101};
        register_classdb_global(&global_classdb_array[398], (const char *)data, 23);
    }
    {
        // ShaderMaterial
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[400], (const char *)data, 18);
    }
    {
        // CPUParticles2D
        char data[] = {67, 80, 85, 80, 97, 114, 116, 105, 99, 108, 101, 115, 50, 68};
        register_classdb_global(&global_classdb_array[401], (const char *)data, 14);
    }
    {
        // Sprite
        char data[] = {83, 112, 114, 105, 116, 101};
        register_classdb_global(&global_classdb_array[402], (const char *)data, 6);
    }
    {
        // Line2D
        char data[] = {76, 105, 110, 101, 50, 68};
        register_classdb_global(&global_classdb_array[403], (const char *)data, 6);
    }
    {
        // MeshInstance2D
        char data[] = {77, 101, 115, 104, 73, 110, 115, 116, 97, 110, 99, 101, 50, 68};
        register_classdb_global(&global_classdb_array[404], (const char *)data, 14);
    }
    {
        // MultiMeshInstance2D
        char data[] = {77, 117, 108, 116, 105, 77, 101, 115, 104, 73, 110, 115, 116, 97, 110, 99, 101, 50, 68};
        register_classdb_global(&global_classdb_array[405], (const char *)data, 19);
    }
    {
        // CollisionObject2D
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 79, 98, 106, 101, 99, 116, 50, 68};
        register_classdb_global(&global_classdb_array[406], (const char *)data, 17);
    }
    {
        // PhysicsBody2D
        char data[] = {80, 104, 121, 115, 105, 99, 115, 66, 111, 100, 121, 50, 68};
        register_classdb_global(&global_classdb_array[407], (const char *)data, 13);
    }
    {
        // KinematicBody2D
        char data[] = {75, 105, 110, 101, 109, 97, 116, 105, 99, 66, 111, 100, 121, 50, 68};
        register_classdb_global(&global_classdb_array[408], (const char *)data, 15);
    }
    {
        // Shape2D
        char data[] = {83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[409], (const char *)data, 7);
    }
    {
        // CollisionPolygon2D
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 80, 111, 108, 121, 103, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[410], (const char *)data, 18);
    }
    {
        // RayCast2D
        char data[] = {82, 97, 121, 67, 97, 115, 116, 50, 68};
        register_classdb_global(&global_classdb_array[411], (const char *)data, 9);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[413], (const char *)data, 19);
    }
    {
        // Polygon2D
        char data[] = {80, 111, 108, 121, 103, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[414], (const char *)data, 9);
    }
    {
        // LightOccluder2D
        char data[] = {76, 105, 103, 104, 116, 79, 99, 99, 108, 117, 100, 101, 114, 50, 68};
        register_classdb_global(&global_classdb_array[415], (const char *)data, 15);
    }
    {
        // OccluderPolygon2D
        char data[] = {79, 99, 99, 108, 117, 100, 101, 114, 80, 111, 108, 121, 103, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[416], (const char *)data, 17);
    }
    {
        // YSort
        char data[] = {89, 83, 111, 114, 116};
        register_classdb_global(&global_classdb_array[417], (const char *)data, 5);
    }
    {
        // BackBufferCopy
        char data[] = {66, 97, 99, 107, 66, 117, 102, 102, 101, 114, 67, 111, 112, 121};
        register_classdb_global(&global_classdb_array[418], (const char *)data, 14);
    }
    {
        // Joint2D
        char data[] = {74, 111, 105, 110, 116, 50, 68};
        register_classdb_global(&global_classdb_array[419], (const char *)data, 7);
    }
    {
        // PinJoint2D
        char data[] = {80, 105, 110, 74, 111, 105, 110, 116, 50, 68};
        register_classdb_global(&global_classdb_array[420], (const char *)data, 10);
    }
    {
        // GrooveJoint2D
        char data[] = {71, 114, 111, 111, 118, 101, 74, 111, 105, 110, 116, 50, 68};
        register_classdb_global(&global_classdb_array[421], (const char *)data, 13);
    }
    {
        // DampedSpringJoint2D
        char data[] = {68, 97, 109, 112, 101, 100, 83, 112, 114, 105, 110, 103, 74, 111, 105, 110, 116, 50, 68};
        register_classdb_global(&global_classdb_array[422], (const char *)data, 19);
    }
    {
        // TileSet
        char data[] = {84, 105, 108, 101, 83, 101, 116};
        register_classdb_global(&global_classdb_array[423], (const char *)data, 7);
    }
    {
        // TileMap
        char data[] = {84, 105, 108, 101, 77, 97, 112};
        register_classdb_global(&global_classdb_array[424], (const char *)data, 7);
    }
    {
        // TouchScreenButton
        char data[] = {84, 111, 117, 99, 104, 83, 99, 114, 101, 101, 110, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[425], (const char *)data, 17);
    }
    {
        // CurveTexture
        char data[] = {67, 117, 114, 118, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[426], (const char *)data, 12);
    }
    {
        // GradientTexture
        char data[] = {71, 114, 97, 100, 105, 101, 110, 116, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[427], (const char *)data, 15);
    }
    {
        // ArrayMesh
        char data[] = {65, 114, 114, 97, 121, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[428], (const char *)data, 9);
    }
    {
        // SurfaceTool
        char data[] = {83, 117, 114, 102, 97, 99, 101, 84, 111, 111, 108};
        register_classdb_global(&global_classdb_array[429], (const char *)data, 11);
    }
    {
        // MeshDataTool
        char data[] = {77, 101, 115, 104, 68, 97, 116, 97, 84, 111, 111, 108};
        register_classdb_global(&global_classdb_array[430], (const char *)data, 12);
    }
    {
        // PrimitiveMesh
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[432], (const char *)data, 11);
    }
    {
        // CubeMesh
        char data[] = {67, 117, 98, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[433], (const char *)data, 8);
    }
    {
        // CylinderMesh
        char data[] = {67, 121, 108, 105, 110, 100, 101, 114, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[434], (const char *)data, 12);
    }
    {
        // PlaneMesh
        char data[] = {80, 108, 97, 110, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[435], (const char *)data, 9);
    }
    {
        // PrismMesh
        char data[] = {80, 114, 105, 115, 109, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[436], (const char *)data, 9);
    }
    {
        // QuadMesh
        char data[] = {81, 117, 97, 100, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[437], (const char *)data, 8);
    }
    {
        // SphereMesh
        char data[] = {83, 112, 104, 101, 114, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[438], (const char *)data, 10);
    }
    {
        // PointMesh
        char data[] = {80, 111, 105, 110, 116, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[439], (const char *)data, 9);
    }
    {
        // SpatialMaterial
        char data[] = {83, 112, 97, 116, 105, 97, 108, 77, 97, 116, 101, 114, 105, 97, 108};
        register_classdb_global(&global_classdb_array[440], (const char *)data, 15);
    }
    {
        // MeshLibrary
        char data[] = {77, 101, 115, 104, 76, 105, 98, 114, 97, 114, 121};
        register_classdb_global(&global_classdb_array[441], (const char *)data, 11);
    }
    {
        // RayShape
        char data[] = {82, 97, 121, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[442], (const char *)data, 8);
    }
    {
        // Sky
        char data[] = {83, 107, 121};
        register_classdb_global(&global_classdb_array[443], (const char *)data, 3);
    }
    {
        // PanoramaSky
        char data[] = {80, 97, 110, 111, 114, 97, 109, 97, 83, 107, 121};
        register_classdb_global(&global_classdb_array[444], (const char *)data, 11);
    }
    {
        // ProceduralSky
        char data[] = {80, 114, 111, 99, 101, 100, 117, 114, 97, 108, 83, 107, 121};
        register_classdb_global(&global_classdb_array[445], (const char *)data, 13);
    }
    {
        // StreamTexture
        char data[] = {83, 116, 114, 101, 97, 109, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[446], (const char *)data, 13);
    }
    {
        // ImageTexture
        char data[] = {73, 109, 97, 103, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[447], (const char *)data, 12);
    }
    {
        // AtlasTexture
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[449], (const char *)data, 11);
    }
    {
        // LargeTexture
        char data[] = {76, 97, 114, 103, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[450], (const char *)data, 12);
    }
    {
        // TextureLayered
        char data[] = {84, 101, 120, 116, 117, 114, 101, 76, 97, 121, 101, 114, 101, 100};
        register_classdb_global(&global_classdb_array[451], (const char *)data, 14);
    }
    {
        // Texture3D
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[453], (const char *)data, 12);
    }
    {
        // Animation
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[454], (const char *)data, 9);
    }
    {
        // Font
        char data[] = {70, 111, 110, 116};
        register_classdb_global(&global_classdb_array[455], (const char *)data, 4);
    }
    {
        // BitmapFont
        char data[] = {66, 105, 116, 109, 97, 112, 70, 111, 110, 116};
        register_classdb_global(&global_classdb_array[456], (const char *)data, 10);
    }
    {
        // DynamicFont
        char data[] = {68, 121, 110, 97, 109, 105, 99, 70, 111, 110, 116};
        register_classdb_global(&global_classdb_array[457], (const char *)data, 11);
    }
    {
        // StyleBoxEmpty
        char data[] = {83, 116, 121, 108, 101, 66, 111, 120, 69, 109, 112, 116, 121};
        register_classdb_global(&global_classdb_array[458], (const char *)data, 13);
    }
    {
        // StyleBoxTexture
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[460], (const char *)data, 12);
    }
    {
        // PolygonPathFinder
        char data[] = {80, 111, 108, 121, 103, 111, 110, 80, 97, 116, 104, 70, 105, 110, 100, 101, 114};
        register_classdb_global(&global_classdb_array[461], (const char *)data, 17);
    }
    {
        // AudioStreamPlayer
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 80, 108, 97, 121, 101, 114};
        register_classdb_global(&global_classdb_array[462], (const char *)data, 17);
    }
    {
        // AudioStreamPlayer2D
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 80, 108, 97, 121, 101, 114, 50, 68};
        register_classdb_global(&global_classdb_array[463], (const char *)data, 19);
    }
    {
        // AudioStreamPlayer3D
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 80, 108, 97, 121, 101, 114, 51, 68};
        register_classdb_global(&global_classdb_array[464], (const char *)data, 19);
    }
    {
        // AudioStreamSample
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 83, 97, 109, 112, 108, 101};
        register_classdb_global(&global_classdb_array[465], (const char *)data, 17);
    }
    {
        // LineShape2D
        char data[] = {76, 105, 110, 101, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[466], (const char *)data, 11);
    }
    {
        // SegmentShape2D
        char data[] = {83, 101, 103, 109, 101, 110, 116, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[467], (const char *)data, 14);
    }
    {
        // RayShape2D
        char data[] = {82, 97, 121, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[468], (const char *)data, 10);
    }
    {
        // CircleShape2D
        char data[] = {67, 105, 114, 99, 108, 101, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[469], (const char *)data, 13);
    }
    {
        // RectangleShape2D
        char data[] = {82, 101, 99, 116, 97, 110, 103, 108, 101, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[470], (const char *)data, 16);
    }
    {
        // CapsuleShape2D
        char data[] = {67, 97, 112, 115, 117, 108, 101, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[471], (const char *)data, 14);
    }
    {
        // ConvexPolygonShape2D
        char data[] = {67, 111, 110, 118, 101, 120, 80, 111, 108, 121, 103, 111, 110, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[472], (const char *)data, 20);
    }
    {
        // ConcavePolygonShape2D
        char data[] = {67, 111, 110, 99, 97, 118, 101, 80, 111, 108, 121, 103, 111, 110, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[473], (const char *)data, 21);
    }
    {
        // Curve2D
        char data[] = {67, 117, 114, 118, 101, 50, 68};
        register_classdb_global(&global_classdb_array[474], (const char *)data, 7);
    }
    {
        // Path2D
        char data[] = {80, 97, 116, 104, 50, 68};
        register_classdb_global(&global_classdb_array[475], (const char *)data, 6);
    }
    {
        // NavigationPolygon
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110, 80, 111, 108, 121, 103, 111, 110};
        register_classdb_global(&global_classdb_array[476], (const char *)data, 17);
    }
    {
        // NavigationPolygonInstance
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110, 80, 111, 108, 121, 103, 111, 110, 73, 110, 115, 116, 97, 110, 99, 101};
        register_classdb_global(&global_classdb_array[477], (const char *)data, 25);
    }
    {
        // SceneState
        char data[] = {83, 99, 101, 110, 101, 83, 116, 97, 116, 101};
        register_classdb_global(&global_classdb_array[478], (const char *)data, 10);
    }
    {
        // PackedScene
        char data[] = {80, 97, 99, 107, 101, 100, 83, 99, 101, 110, 101};
        register_classdb_global(&global_classdb_array[479], (const char *)data, 11);
    }
    {
        // SceneTree
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[481], (const char *)data, 14);
    }
    {
        // StyleBoxLine
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[483], (const char *)data, 12);
    }
    {
        // Navigation2D
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[484], (const char *)data, 12);
    }
    {
        // EditorScript
        char data[] = {69, 100, 105, 116, 111, 114, 83, 99, 114, 105, 112, 116};
        register_classdb_global(&global_classdb_array[485], (const char *)data, 12);
    }
    {
        // EditorSelection
        char data[] = {69, 100, 105, 116, 111, 114, 83, 101, 108, 101, 99, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[486], (const char *)data, 15);
    }
    {
        // EditorSettings
        char data[] = {69, 100, 105, 116, 111, 114, 83, 101, 116, 116, 105, 110, 103, 115};
        register_classdb_global(&global_classdb_array[487], (const char *)data, 14);
    }
    {
        // EditorSpatialGizmo
        char data[] = {69, 100, 105, 116, 111, 114, 83, 112, 97, 116, 105, 97, 108, 71, 105, 122, 109, 111};
        register_classdb_global(&global_classdb_array[488], (const char *)data, 18);
    }
    {
        // EditorInspectorPlugin
        char data[] = {69, 100, 105, 116, 111, 114, 73, 110, 115, 112, 101, 99, 116, 111, 114, 80, 108, 117, 103, 105, 110};
        register_classdb_global(&global_classdb_array[489], (const char *)data, 21);
    }
    {
        // EditorProperty
        char data[] = {69, 100, 105, 116, 111, 114, 80, 114, 111, 112, 101, 114, 116, 121};
        register_classdb_global(&global_classdb_array[490], (const char *)data, 14);
    }
    {
        // ScriptCreateDialog
        char data[] = {83, 99, 114, 105, 112, 116, 67, 114, 101, 97, 116, 101, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[491], (const char *)data, 18);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[493], (const char *)data, 21);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[494], (const char *)data, 25);
    }
    {
        // CSGSphere
        char data[] = {67, 83, 71, 83, 112, 104, 101, 114, 101};
        register_classdb_global(&global_classdb_array[495], (const char *)data, 9);
    }
    {
        // CSGPolygon
        char data[] = {67, 83, 71, 80, 111, 108, 121, 103, 111, 110};
        register_classdb_global(&global_classdb_array[496], (const char *)data, 10);
    }
    {
        // NetworkedMultiplayerENet
        char data[] = {78, 101, 116, 119, 111, 114, 107, 101, 100, 77, 117, 108, 116, 105, 112, 108, 97, 121, 101, 114, 69, 78, 101, 116};
        register_classdb_global(&global_classdb_array[497], (const char *)data, 24);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[498], (const char *)data, 24);
    }
    {
        // GD2CApi
        char data[] = {71, 68, 50, 67, 65, 112, 105};
        register_classdb_global(&global_classdb_array[499], (const char *)data, 7);
    }
    {
        // GDNativeLibrary
        char data[] = {71, 68, 78, 97, 116, 105, 118, 101, 76, 105, 98, 114, 97, 114, 121};
        register_classdb_global(&global_classdb_array[500], (const char *)data, 15);
    }
    {
        // GDNative
        char data[] = {71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[501], (const char *)data, 8);
    }
    {
        // MultiplayerPeerGDNative
        char data[] = {77, 117, 108, 116, 105, 112, 108, 97, 121, 101, 114, 80, 101, 101, 114, 71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[502], (const char *)data, 23);
    }
    {
        // PacketPeerGDNative
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[532], (const char *)data, 30);
    }
    {
        // EditorFileSystem
        char data[] = {69, 100, 105, 116, 111, 114, 70, 105, 108, 101, 83, 121, 115, 116, 101, 109};
        register_classdb_global(&global_classdb_array[533], (const char *)data, 16);
    }
    {
        // EditorFileSystemDirectory
        char data[] = {69, 100, 105, 116, 111, 114, 70, 105, 108, 101, 83, 121, 115, 116, 101, 109, 68, 105, 114, 101, 99, 116, 111, 114, 121};
        register_classdb_global(&global_classdb_array[534], (const char *)data, 25);
    }
    {
        // EditorVCSInterface
        char data[] = {69, 100, 105, 116, 111, 114, 86, 67, 83, 73, 110, 116, 101, 114, 102, 97, 99, 101};
        register_classdb_global(&global_classdb_array[535], (const char *)data, 18);
    }
    {
        // ScriptEditor
        char data[] = {83, 99, 114, 105, 112, 116, 69, 100, 105, 116, 111, 114};
        register_classdb_global(&global_classdb_array[536], (const char *)data, 12);
    }
    {
        // EditorInterface
        char data[] = {69, 100, 105, 116, 111, 114, 73, 110, 116, 101, 114, 102, 97, 99, 101};
        register_classdb_global(&global_classdb_array[537], (const char *)data, 15);
    }
    {
        // EditorExportPlugin
        char data[] = {69, 100, 105, 116, 111, 114, 69, 120, 112, 111, 114, 116, 80, 108, 117, 103, 105, 110};
        register_classdb_global(&global_classdb_array[538], (const char *)data, 18);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[539], (const char *)data, 30);
    }
    {
        // EditorSceneImporter
        char data[] = {69, 100, 105, 116, 111, 114, 83, 99, 101, 110, 101, 73, 109, 112, 111, 114, 116, 101, 114};
        register_classdb_global(&global_classdb_array[540], (const char *)data, 19);
    }
    {
        // EditorInspector
        char data[] = {69, 100, 105, 116, 111, 114, 73, 110, 115, 112, 101, 99, 116, 111, 114};
        register_classdb_global(&global_classdb_array[541], (const char *)data, 15);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[543], (const char *)data, 8);
    }
    {
        // CSGPrimitive
        char data[] = {67, 83, 71, 80, 114, 105, 109, 105, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[544], (const char *)data, 12);
    }
    {
        // CSGMesh
        char data[] = {67, 83, 71, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[545], (const char *)data, 7);
    }
    {
        // CSGBox
        char data[] = {67, 83, 71, 66, 111, 120};
        register_classdb_global(&global_classdb_array[546], (const char *)data, 6);
    }
    {
        // CSGCylinder
        char data[] = {67, 83, 71, 67, 121, 108, 105, 110, 100, 101, 114};
        register_classdb_global(&global_classdb_array[547], (const char *)data, 11);
    }
    {
        // CSGTorus
        char data[] = {67, 83, 71, 84, 111, 114, 117, 115};
        register_classdb_global(&global_classdb_array[548], (const char *)data, 8);
    }
    {
        // CSGCombiner
        char data[] = {67, 83, 71, 67, 111, 109, 98, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[549], (const char *)data, 11);
    }
    {
        // ARVRInterfaceGDNative
        char data[] = {65, 82, 86, 82, 73, 110, 116, 101, 114, 102, 97, 99, 101, 71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[550], (const char *)data, 21);
    }
    {
        // VideoStreamGDNative
        char data[] = {86, 105, 100, 101, 111, 83, 116, 114, 101, 97, 109, 71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[551], (const char *)data, 19);
    }
    {
        // PluginScript
        char data[] = {80, 108, 117, 103, 105, 110, 83, 99, 114, 105, 112, 116};
        register_classdb_global(&global_classdb_array[552], (const char *)data, 12);
    }
    {
        // GDScript
        char data[] = {71, 68, 83, 99, 114, 105, 112, 116};
        register_classdb_global(&global_classdb_array[553], (const char *)data, 8);
    }
    {
        // GridMap
        char data[] = {71, 114, 105, 100, 77, 97, 112};
        register_classdb_global(&global_classdb_array[554], (const char *)data, 7);
    }
    {
        // OpenSimplexNoise
        char data[] = {79, 112, 101, 110, 83, 105, 109, 112, 108, 101, 120, 78, 111, 105, 115, 101};
        register_classdb_global(&global_classdb_array[555], (const char *)data, 16);
    }
    {
        // NoiseTexture
        char data[] = {78, 111, 105, 115, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[556], (const char *)data, 12);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[557], (const char *)data, 29);
    }
    {
        // RegExMatch
        char data[] = {82, 101, 103, 69, 120, 77, 97, 116, 99, 104};
        register_classdb_global(&global_classdb_array[558], (const char *)data, 10);
    }
    {
        // UPNP
        char data[] = {85, 80, 78, 80};
        register_classdb_global(&global_classdb_array[559], (const char *)data, 4);
    }
    {
        // UPNPDevice
        char data[] = {85, 80, 78, 80, 68, 101, 118, 105, 99, 101};
        register_classdb_global(&global_classdb_array[560], (const char *)data, 10);
    }
    {
        // VisualScript
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116};
        register_classdb_global(&global_classdb_array[561], (const char *)data, 12);
    }
    {
        // VisualScriptNode
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[562], (const char *)data, 16);
    }
    {
        // VisualScriptFunction
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 70, 117, 110, 99, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[563], (const char *)data, 20);
    }
    {
        // VisualScriptLists
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 76, 105, 115, 116, 115};
        register_classdb_global(&global_classdb_array[564], (const char *)data, 17);
    }
    {
        // VisualScriptComposeArray
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 67, 111, 109, 112, 111, 115, 101, 65, 114, 114, 97, 121};
        register_classdb_global(&global_classdb_array[565], (const char *)data, 24);
    }
    {
        // VisualScriptOperator
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 79, 112, 101, 114, 97, 116, 111, 114};
        register_classdb_global(&global_classdb_array[566], (const char *)data, 20);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[568], (const char *)data, 24);
    }
    {
        // VisualScriptSceneNode
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 83, 99, 101, 110, 101, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[569], (const char *)data, 21);
    }
    {
        // VisualScriptSceneTree
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 83, 99, 101, 110, 101, 84, 114, 101, 101};
        register_classdb_global(&global_classdb_array[570], (const char *)data, 21);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[572], (const char *)data, 16);
    }
    {
        // VisualScriptCustomNode
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 67, 117, 115, 116, 111, 109, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[573], (const char *)data, 22);
    }
    {
        // VisualScriptComment
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[575], (const char *)data, 23);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[608], (const char *)data, 29);
    }
    {
        // GDScriptNativeClass
