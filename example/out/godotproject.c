...
godot_variant global_classdb_array[591];
...
godot_variant Class_1__init_func(godot_object *p_instance, void *p_method_data, void *_p_user_data, int p_num_args, godot_variant **p_args)
{
    ...
    {
        {
            uint8_t data[] = {4, 0, 0, 0, 4, 0, 0, 0, 116, 101, 115, 116};
            int bytesRead;
            gd2c10->variant_decode(&Class_1__init_local_const[0], data, 12, &bytesRead, true);
        }
        {
            uint8_t data[] = {4, 0, 0, 0, 4, 0, 0, 0, 67, 49, 58, 32};
            int bytesRead;
            gd2c10->variant_decode(&Class_1__init_local_const[1], data, 12, &bytesRead, true);
        }
        {
            char data[] = {95, 105, 110, 105, 116};
            api10->godot_string_new(&Class_1__init_strings[0]);
            api10->godot_string_parse_utf8_with_len(&Class_1__init_strings[0], data, 5);
            api10->godot_string_name_new(&Class_1__init_string_names[0], &Class_1__init_strings[0]);
        }
        {
            char data[] = {67, 49};
            api10->godot_string_new(&Class_1__init_strings[1]);
            api10->godot_string_parse_utf8_with_len(&Class_1__init_strings[1], data, 2);
            api10->godot_string_name_new(&Class_1__init_string_names[1], &Class_1__init_strings[1]);
        }
...
_2:
...

    {
        ...
        gd2c10->call_gdscript_builtin(62, (const godot_variant **)args, 1, &st_0, &err);
    }
    {
        godot_variant *args[] = {&Class_1_constants[0]};
        godot_variant_call_error err;
        gd2c10->call_gdscript_builtin(61, (const godot_variant **)args, 1, &st_1, &err);
    }
    api11->godot_variant_evaluate(6, &Class_1__init_local_const[1], &st_1, &st_0, &__flag);
    {
...
godot_variant Class_3__init_func(godot_object *p_instance, void *p_method_data, void *_p_user_data, int p_num_args, godot_variant **p_args)
{
    ...
    {
        {
            uint8_t data[] = {4, 0, 0, 0, 12, 0, 0, 0, 116, 101, 115, 116, 95, 100, 101, 114, 105, 118, 101, 100};
            int bytesRead;
            gd2c10->variant_decode(&Class_3__init_local_const[0], data, 20, &bytesRead, true);
        }
        {
            uint8_t data[] = {4, 0, 0, 0, 4, 0, 0, 0, 67, 49, 58, 32};
            int bytesRead;
            gd2c10->variant_decode(&Class_3__init_local_const[1], data, 12, &bytesRead, true);
        }
        {
            uint8_t data[] = {4, 0, 0, 0, 4, 0, 0, 0, 67, 50, 58, 32};
            int bytesRead;
            gd2c10->variant_decode(&Class_3__init_local_const[2], data, 12, &bytesRead, true);
        }
        {
            char data[] = {95, 105, 110, 105, 116};
        ...
        {
            char data[] = {67, 49};
            api10->godot_string_new(&Class_3__init_strings[1]);
            api10->godot_string_parse_utf8_with_len(&Class_3__init_strings[1], data, 2);
            api10->godot_string_name_new(&Class_3__init_string_names[1], &Class_3__init_strings[1]);
        }
        {
            char data[] = {67, 50};
            api10->godot_string_new(&Class_3__init_strings[2]);
            api10->godot_string_parse_utf8_with_len(&Class_3__init_strings[2], data, 2);
            api10->godot_string_name_new(&Class_3__init_string_names[2], &Class_3__init_strings[2]);
        }
...
_2:
{
    ...
    {
        godot_variant *args[] = {&Class_3__init_local_const[0]};
        godot_variant_call_error err;
        gd2c10->call_gdscript_builtin(62, (const godot_variant **)args, 1, &st_0, &err);
    }
    {
    ...
    api11->godot_variant_evaluate(6, &Class_3__init_local_const[1], &st_1, &st_0, &__flag);
    {
        godot_variant *args[] = {&st_0};
        godot_variant_call_error err;
        gd2c10->call_gdscript_builtin(62, (const godot_variant **)args, 1, &st_0, &err);
    ...
    {
        godot_variant *args[] = {&Class_3_constants[0]};
        godot_variant_call_error err;
        gd2c10->call_gdscript_builtin(61, (const godot_variant **)args, 1, &st_1, &err);
    }
    api11->godot_variant_evaluate(6, &Class_3__init_local_const[2], &st_1, &st_0, &__flag);
    {
        godot_variant *args[] = {&st_0};
        godot_variant_call_error err;
        gd2c10->call_gdscript_builtin(62, (const godot_variant **)args, 1, &st_0, &err);
...
{
    vtable_init(&Class_3_vtable, &Class_1_vtable, 4, 1, (void *)0, Class_3_vtable_methods, Class_3_vtable_method_names);
...
void GDN_EXPORT godot_gdnative_terminate(godot_gdnative_terminate_options *p_options)
{
    ...
    if (0 != Class_3_constants_initialized)
    {
        api10->godot_variant_destroy(&Class_3_constants[0]);
    }
    if (0 != Class_3__init_local_const_initialized)
    {
        api10->godot_variant_destroy(&Class_3__init_local_const[0]);
        api10->godot_variant_destroy(&Class_3__init_local_const[1]);
        api10->godot_variant_destroy(&Class_3__init_local_const[2]);
    }
}
void GDN_EXPORT godot_nativescript_init(void *p_handle)
{
    //printf("Enter: godot_nativescript_init\n");
    {
        ...
        nativescript10->godot_nativescript_register_class(p_handle, "Class_1", "Reference", create, destroy);
    }
    {
    ...
    Class_1_vtable_init();
    {
        ...
        nativescript10->godot_nativescript_register_class(p_handle, "Class_3", "Reference", create, destroy);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[4], (const char *)data, 14);
    }
    {
        // MainLoop
        char data[] = {77, 97, 105, 110, 76, 111, 111, 112};
        register_classdb_global(&global_classdb_array[5], (const char *)data, 8);
    }
    {
        // Translation
        char data[] = {84, 114, 97, 110, 115, 108, 97, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[6], (const char *)data, 11);
    }
    {
        // PHashTranslation
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[8], (const char *)data, 8);
    }
    {
        // HTTPClient
        char data[] = {72, 84, 84, 80, 67, 108, 105, 101, 110, 116};
        register_classdb_global(&global_classdb_array[9], (const char *)data, 10);
    }
    {
        // TriangleMesh
        char data[] = {84, 114, 105, 97, 110, 103, 108, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[10], (const char *)data, 12);
    }
    {
        // ResourceInteractiveLoader
        char data[] = {82, 101, 115, 111, 117, 114, 99, 101, 73, 110, 116, 101, 114, 97, 99, 116, 105, 118, 101, 76, 111, 97, 100, 101, 114};
        register_classdb_global(&global_classdb_array[11], (const char *)data, 25);
    }
    {
        // _File
        char data[] = {95, 70, 105, 108, 101};
        register_classdb_global(&global_classdb_array[12], (const char *)data, 5);
    }
    {
        // _Directory
        char data[] = {95, 68, 105, 114, 101, 99, 116, 111, 114, 121};
        register_classdb_global(&global_classdb_array[13], (const char *)data, 10);
    }
    {
        // _Thread
        char data[] = {95, 84, 104, 114, 101, 97, 100};
        register_classdb_global(&global_classdb_array[14], (const char *)data, 7);
    }
    {
        // _Mutex
        char data[] = {95, 77, 117, 116, 101, 120};
        register_classdb_global(&global_classdb_array[15], (const char *)data, 6);
    }
    {
        // _Semaphore
        char data[] = {95, 83, 101, 109, 97, 112, 104, 111, 114, 101};
        register_classdb_global(&global_classdb_array[16], (const char *)data, 10);
    }
    {
        // XMLParser
        char data[] = {88, 77, 76, 80, 97, 114, 115, 101, 114};
        register_classdb_global(&global_classdb_array[17], (const char *)data, 9);
    }
    {
        // ConfigFile
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[20], (const char *)data, 19);
    }
    {
        // PackedDataContainerRef
        char data[] = {80, 97, 99, 107, 101, 100, 68, 97, 116, 97, 67, 111, 110, 116, 97, 105, 110, 101, 114, 82, 101, 102};
        register_classdb_global(&global_classdb_array[21], (const char *)data, 22);
    }
    {
        // AStar
        char data[] = {65, 83, 116, 97, 114};
        register_classdb_global(&global_classdb_array[22], (const char *)data, 5);
    }
    {
        // AStar2D
        char data[] = {65, 83, 116, 97, 114, 50, 68};
        register_classdb_global(&global_classdb_array[23], (const char *)data, 7);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[24], (const char *)data, 20);
    }
    {
        // Object
        char data[] = {79, 98, 106, 101, 99, 116};
        register_classdb_global(&global_classdb_array[25], (const char *)data, 6);
    }
    {
        // WeakRef
        char data[] = {87, 101, 97, 107, 82, 101, 102};
        register_classdb_global(&global_classdb_array[26], (const char *)data, 7);
    }
    {
        // Image
        char data[] = {73, 109, 97, 103, 101};
        register_classdb_global(&global_classdb_array[27], (const char *)data, 5);
    }
    {
        // InputEvent
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[29], (const char *)data, 23);
    }
    {
        // InputEventKey
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[31], (const char *)data, 15);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[33], (const char *)data, 21);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[35], (const char *)data, 22);
    }
    {
        // InputEventScreenDrag
        char data[] = {73, 110, 112, 117, 116, 69, 118, 101, 110, 116, 83, 99, 114, 101, 101, 110, 68, 114, 97, 103};
        register_classdb_global(&global_classdb_array[36], (const char *)data, 20);
    }
    {
        // InputEventScreenTouch
        char data[] = {73, 110, 112, 117, 116, 69, 118, 101, 110, 116, 83, 99, 114, 101, 101, 110, 84, 111, 117, 99, 104};
        register_classdb_global(&global_classdb_array[37], (const char *)data, 21);
    }
    {
        // InputEventAction
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[39], (const char *)data, 17);
    }
    {
        // InputEventMagnifyGesture
        char data[] = {73, 110, 112, 117, 116, 69, 118, 101, 110, 116, 77, 97, 103, 110, 105, 102, 121, 71, 101, 115, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[40], (const char *)data, 24);
    }
    {
        // InputEventPanGesture
        char data[] = {73, 110, 112, 117, 116, 69, 118, 101, 110, 116, 80, 97, 110, 71, 101, 115, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[41], (const char *)data, 20);
    }
    {
        // InputEventMIDI
        char data[] = {73, 110, 112, 117, 116, 69, 118, 101, 110, 116, 77, 73, 68, 73};
        register_classdb_global(&global_classdb_array[42], (const char *)data, 14);
    }
    {
        // FuncRef
        char data[] = {70, 117, 110, 99, 82, 101, 102};
        register_classdb_global(&global_classdb_array[43], (const char *)data, 7);
    }
    {
        // StreamPeer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[45], (const char *)data, 16);
    }
    {
        // StreamPeerTCP
        char data[] = {83, 116, 114, 101, 97, 109, 80, 101, 101, 114, 84, 67, 80};
        register_classdb_global(&global_classdb_array[46], (const char *)data, 13);
    }
    {
        // TCP_Server
        char data[] = {84, 67, 80, 95, 83, 101, 114, 118, 101, 114};
        register_classdb_global(&global_classdb_array[47], (const char *)data, 10);
    }
    {
        // PacketPeer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[49], (const char *)data, 13);
    }
    {
        // StreamPeerSSL
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[51], (const char *)data, 16);
    }
    {
        // NetworkedMultiplayerPeer
        char data[] = {78, 101, 116, 119, 111, 114, 107, 101, 100, 77, 117, 108, 116, 105, 112, 108, 97, 121, 101, 114, 80, 101, 101, 114};
        register_classdb_global(&global_classdb_array[52], (const char *)data, 24);
    }
    {
        // EncodedObjectAsID
        char data[] = {69, 110, 99, 111, 100, 101, 100, 79, 98, 106, 101, 99, 116, 65, 115, 73, 68};
        register_classdb_global(&global_classdb_array[53], (const char *)data, 17);
    }
    {
        // RandomNumberGenerator
        char data[] = {82, 97, 110, 100, 111, 109, 78, 117, 109, 98, 101, 114, 71, 101, 110, 101, 114, 97, 116, 111, 114};
        register_classdb_global(&global_classdb_array[54], (const char *)data, 21);
    }
    {
        // JSONParseResult
        char data[] = {74, 83, 79, 78, 80, 97, 114, 115, 101, 82, 101, 115, 117, 108, 116};
        register_classdb_global(&global_classdb_array[55], (const char *)data, 15);
    }
    {
        // ResourceImporter
        char data[] = {82, 101, 115, 111, 117, 114, 99, 101, 73, 109, 112, 111, 114, 116, 101, 114};
        register_classdb_global(&global_classdb_array[56], (const char *)data, 16);
    }
    {
        // IP_Unix
        char data[] = {73, 80, 95, 85, 110, 105, 120};
        register_classdb_global(&global_classdb_array[57], (const char *)data, 7);
    }
    {
        // _Geometry
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[59], (const char *)data, 15);
    }
    {
        // _ResourceSaver
        char data[] = {95, 82, 101, 115, 111, 117, 114, 99, 101, 83, 97, 118, 101, 114};
        register_classdb_global(&global_classdb_array[60], (const char *)data, 14);
    }
    {
        // _OS
        char data[] = {95, 79, 83};
        register_classdb_global(&global_classdb_array[61], (const char *)data, 3);
    }
    {
        // _Engine
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[63], (const char *)data, 8);
    }
    {
        // _Marshalls
        char data[] = {95, 77, 97, 114, 115, 104, 97, 108, 108, 115};
        register_classdb_global(&global_classdb_array[64], (const char *)data, 10);
    }
    {
        // _JSON
        char data[] = {95, 74, 83, 79, 78};
        register_classdb_global(&global_classdb_array[65], (const char *)data, 5);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[66], (const char *)data, 12);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[93], (const char *)data, 6);
    }
    {
        // BoxContainer
        char data[] = {66, 111, 120, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[94], (const char *)data, 12);
    }
    {
        // HBoxContainer
        char data[] = {72, 66, 111, 120, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[95], (const char *)data, 13);
    }
    {
        // VBoxContainer
        char data[] = {86, 66, 111, 120, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[96], (const char *)data, 13);
    }
    {
        // GridContainer
        char data[] = {71, 114, 105, 100, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[97], (const char *)data, 13);
    }
    {
        // CenterContainer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[99], (const char *)data, 15);
    }
    {
        // PanelContainer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[101], (const char *)data, 15);
    }
    {
        // ItemList
        char data[] = {73, 116, 101, 109, 76, 105, 115, 116};
        register_classdb_global(&global_classdb_array[102], (const char *)data, 8);
    }
    {
        // LineEdit
        char data[] = {76, 105, 110, 101, 69, 100, 105, 116};
        register_classdb_global(&global_classdb_array[103], (const char *)data, 8);
    }
    {
        // VideoPlayer
        char data[] = {86, 105, 100, 101, 111, 80, 108, 97, 121, 101, 114};
        register_classdb_global(&global_classdb_array[104], (const char *)data, 11);
    }
    {
        // VideoStream
        char data[] = {86, 105, 100, 101, 111, 83, 116, 114, 101, 97, 109};
        register_classdb_global(&global_classdb_array[105], (const char *)data, 11);
    }
    {
        // WindowDialog
        char data[] = {87, 105, 110, 100, 111, 119, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[106], (const char *)data, 12);
    }
    {
        // AcceptDialog
        char data[] = {65, 99, 99, 101, 112, 116, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[107], (const char *)data, 12);
    }
    {
        // ConfirmationDialog
        char data[] = {67, 111, 110, 102, 105, 114, 109, 97, 116, 105, 111, 110, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[108], (const char *)data, 18);
    }
    {
        // FileDialog
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[110], (const char *)data, 9);
    }
    {
        // Tree
        char data[] = {84, 114, 101, 101};
        register_classdb_global(&global_classdb_array[111], (const char *)data, 4);
    }
    {
        // TreeItem
        char data[] = {84, 114, 101, 101, 73, 116, 101, 109};
        register_classdb_global(&global_classdb_array[112], (const char *)data, 8);
    }
    {
        // TextEdit
        char data[] = {84, 101, 120, 116, 69, 100, 105, 116};
        register_classdb_global(&global_classdb_array[113], (const char *)data, 8);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[114], (const char *)data, 10);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[115], (const char *)data, 13);
    }
    {
        // ARVRPositionalTracker
        char data[] = {65, 82, 86, 82, 80, 111, 115, 105, 116, 105, 111, 110, 97, 108, 84, 114, 97, 99, 107, 101, 114};
        register_classdb_global(&global_classdb_array[116], (const char *)data, 21);
    }
    {
        // AudioStream
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109};
        register_classdb_global(&global_classdb_array[117], (const char *)data, 11);
    }
    {
        // AudioStreamPlaybackResampled
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 80, 108, 97, 121, 98, 97, 99, 107, 82, 101, 115, 97, 109, 112, 108, 101, 100};
        register_classdb_global(&global_classdb_array[118], (const char *)data, 28);
    }
    {
        // AudioStreamPlayback
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 80, 108, 97, 121, 98, 97, 99, 107};
        register_classdb_global(&global_classdb_array[119], (const char *)data, 19);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[122], (const char *)data, 11);
    }
    {
        // AudioEffectInstance
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[145], (const char *)data, 16);
    }
    {
        // Node
        char data[] = {78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[146], (const char *)data, 4);
    }
    {
        // InstancePlaceholder
        char data[] = {73, 110, 115, 116, 97, 110, 99, 101, 80, 108, 97, 99, 101, 104, 111, 108, 100, 101, 114};
        register_classdb_global(&global_classdb_array[147], (const char *)data, 19);
    }
    {
        // Viewport
        char data[] = {86, 105, 101, 119, 112, 111, 114, 116};
        register_classdb_global(&global_classdb_array[148], (const char *)data, 8);
    }
    {
        // World
        char data[] = {87, 111, 114, 108, 100};
        register_classdb_global(&global_classdb_array[149], (const char *)data, 5);
    }
    {
        // World2D
        char data[] = {87, 111, 114, 108, 100, 50, 68};
        register_classdb_global(&global_classdb_array[150], (const char *)data, 7);
    }
    {
        // Texture
        char data[] = {84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[151], (const char *)data, 7);
    }
    {
        // ViewportTexture
        char data[] = {86, 105, 101, 119, 112, 111, 114, 116, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[152], (const char *)data, 15);
    }
    {
        // HTTPRequest
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[154], (const char *)data, 5);
    }
    {
        // CanvasLayer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[157], (const char *)data, 6);
    }
    {
        // CanvasModulate
        char data[] = {67, 97, 110, 118, 97, 115, 77, 111, 100, 117, 108, 97, 116, 101};
        register_classdb_global(&global_classdb_array[158], (const char *)data, 14);
    }
    {
        // ResourcePreloader
        char data[] = {82, 101, 115, 111, 117, 114, 99, 101, 80, 114, 101, 108, 111, 97, 100, 101, 114};
        register_classdb_global(&global_classdb_array[159], (const char *)data, 17);
    }
    {
        // ButtonGroup
        char data[] = {66, 117, 116, 116, 111, 110, 71, 114, 111, 117, 112};
        register_classdb_global(&global_classdb_array[160], (const char *)data, 11);
    }
    {
        // Control
        char data[] = {67, 111, 110, 116, 114, 111, 108};
        register_classdb_global(&global_classdb_array[161], (const char *)data, 7);
    }
    {
        // Theme
        char data[] = {84, 104, 101, 109, 101};
        register_classdb_global(&global_classdb_array[162], (const char *)data, 5);
    }
    {
        // BaseButton
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[167], (const char *)data, 5);
    }
    {
        // ScrollBar
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[171], (const char *)data, 11);
    }
    {
        // Slider
        char data[] = {83, 108, 105, 100, 101, 114};
        register_classdb_global(&global_classdb_array[172], (const char *)data, 6);
    }
    {
        // HSlider
        char data[] = {72, 83, 108, 105, 100, 101, 114};
        register_classdb_global(&global_classdb_array[173], (const char *)data, 7);
    }
    {
        // VSlider
        char data[] = {86, 83, 108, 105, 100, 101, 114};
        register_classdb_global(&global_classdb_array[174], (const char *)data, 7);
    }
    {
        // Popup
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[176], (const char *)data, 10);
    }
    {
        // MenuButton
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[178], (const char *)data, 8);
    }
    {
        // CheckButton
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[181], (const char *)data, 10);
    }
    {
        // Panel
        char data[] = {80, 97, 110, 101, 108};
        register_classdb_global(&global_classdb_array[182], (const char *)data, 5);
    }
    {
        // TextureRect
        char data[] = {84, 101, 120, 116, 117, 114, 101, 82, 101, 99, 116};
        register_classdb_global(&global_classdb_array[183], (const char *)data, 11);
    }
    {
        // ColorPickerButton
        char data[] = {67, 111, 108, 111, 114, 80, 105, 99, 107, 101, 114, 66, 117, 116, 116, 111, 110};
        register_classdb_global(&global_classdb_array[184], (const char *)data, 17);
    }
    {
        // RichTextLabel
        char data[] = {82, 105, 99, 104, 84, 101, 120, 116, 76, 97, 98, 101, 108};
        register_classdb_global(&global_classdb_array[185], (const char *)data, 13);
    }
    {
        // ViewportContainer
        char data[] = {86, 105, 101, 119, 112, 111, 114, 116, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[186], (const char *)data, 17);
    }
    {
        // PopupDialog
        char data[] = {80, 111, 112, 117, 112, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[187], (const char *)data, 11);
    }
    {
        // MarginContainer
        char data[] = {77, 97, 114, 103, 105, 110, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[188], (const char *)data, 15);
    }
    {
        // SplitContainer
        char data[] = {83, 112, 108, 105, 116, 67, 111, 110, 116, 97, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[189], (const char *)data, 14);
    }
    {
        // HSplitContainer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[192], (const char *)data, 9);
    }
    {
        // OptionButton
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[195], (const char *)data, 13);
    }
    {
        // ColorPicker
        char data[] = {67, 111, 108, 111, 114, 80, 105, 99, 107, 101, 114};
        register_classdb_global(&global_classdb_array[196], (const char *)data, 11);
    }
    {
        // SpatialGizmo
        char data[] = {83, 112, 97, 116, 105, 97, 108, 71, 105, 122, 109, 111};
        register_classdb_global(&global_classdb_array[197], (const char *)data, 12);
    }
    {
        // Skeleton
        char data[] = {83, 107, 101, 108, 101, 116, 111, 110};
        register_classdb_global(&global_classdb_array[198], (const char *)data, 8);
    }
    {
        // AnimationPlayer
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 80, 108, 97, 121, 101, 114};
        register_classdb_global(&global_classdb_array[199], (const char *)data, 15);
    }
    {
        // Tween
        char data[] = {84, 119, 101, 101, 110};
        register_classdb_global(&global_classdb_array[200], (const char *)data, 5);
    }
    {
        // VisualInstance
        char data[] = {86, 105, 115, 117, 97, 108, 73, 110, 115, 116, 97, 110, 99, 101};
        register_classdb_global(&global_classdb_array[201], (const char *)data, 14);
    }
    {
        // GeometryInstance
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[203], (const char *)data, 6);
    }
    {
        // Environment
        char data[] = {69, 110, 118, 105, 114, 111, 110, 109, 101, 110, 116};
        register_classdb_global(&global_classdb_array[204], (const char *)data, 11);
    }
    {
        // ClippedCamera
        char data[] = {67, 108, 105, 112, 112, 101, 100, 67, 97, 109, 101, 114, 97};
        register_classdb_global(&global_classdb_array[205], (const char *)data, 13);
    }
    {
        // Listener
        char data[] = {76, 105, 115, 116, 101, 110, 101, 114};
        register_classdb_global(&global_classdb_array[206], (const char *)data, 8);
    }
    {
        // ARVRCamera
        char data[] = {65, 82, 86, 82, 67, 97, 109, 101, 114, 97};
        register_classdb_global(&global_classdb_array[207], (const char *)data, 10);
    }
    {
        // ARVRController
        char data[] = {65, 82, 86, 82, 67, 111, 110, 116, 114, 111, 108, 108, 101, 114};
        register_classdb_global(&global_classdb_array[208], (const char *)data, 14);
    }
    {
        // Mesh
        char data[] = {77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[209], (const char *)data, 4);
    }
    {
        // ARVRAnchor
        char data[] = {65, 82, 86, 82, 65, 110, 99, 104, 111, 114};
        register_classdb_global(&global_classdb_array[210], (const char *)data, 10);
    }
    {
        // ARVROrigin
        char data[] = {65, 82, 86, 82, 79, 114, 105, 103, 105, 110};
        register_classdb_global(&global_classdb_array[211], (const char *)data, 10);
    }
    {
        // InterpolatedCamera
        char data[] = {73, 110, 116, 101, 114, 112, 111, 108, 97, 116, 101, 100, 67, 97, 109, 101, 114, 97};
        register_classdb_global(&global_classdb_array[212], (const char *)data, 18);
    }
    {
        // MeshInstance
        char data[] = {77, 101, 115, 104, 73, 110, 115, 116, 97, 110, 99, 101};
        register_classdb_global(&global_classdb_array[213], (const char *)data, 12);
    }
    {
        // ImmediateGeometry
        char data[] = {73, 109, 109, 101, 100, 105, 97, 116, 101, 71, 101, 111, 109, 101, 116, 114, 121};
        register_classdb_global(&global_classdb_array[214], (const char *)data, 17);
    }
    {
        // SpriteBase3D
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[217], (const char *)data, 16);
    }
    {
        // SpriteFrames
        char data[] = {83, 112, 114, 105, 116, 101, 70, 114, 97, 109, 101, 115};
        register_classdb_global(&global_classdb_array[218], (const char *)data, 12);
    }
    {
        // Light
        char data[] = {76, 105, 103, 104, 116};
        register_classdb_global(&global_classdb_array[219], (const char *)data, 5);
    }
    {
        // DirectionalLight
        char data[] = {68, 105, 114, 101, 99, 116, 105, 111, 110, 97, 108, 76, 105, 103, 104, 116};
        register_classdb_global(&global_classdb_array[220], (const char *)data, 16);
    }
    {
        // OmniLight
        char data[] = {79, 109, 110, 105, 76, 105, 103, 104, 116};
        register_classdb_global(&global_classdb_array[221], (const char *)data, 9);
    }
    {
        // SpotLight
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[224], (const char *)data, 7);
    }
    {
        // GIProbeData
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[227], (const char *)data, 17);
    }
    {
        // AnimationTreePlayer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[229], (const char *)data, 9);
    }
    {
        // CPUParticles
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[231], (const char *)data, 5);
    }
    {
        // Gradient
        char data[] = {71, 114, 97, 100, 105, 101, 110, 116};
        register_classdb_global(&global_classdb_array[232], (const char *)data, 8);
    }
    {
        // Position3D
        char data[] = {80, 111, 115, 105, 116, 105, 111, 110, 51, 68};
        register_classdb_global(&global_classdb_array[233], (const char *)data, 10);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[235], (const char *)data, 14);
    }
    {
        // Navigation
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[236], (const char *)data, 10);
    }
    {
        // RootMotionView
        char data[] = {82, 111, 111, 116, 77, 111, 116, 105, 111, 110, 86, 105, 101, 119};
        register_classdb_global(&global_classdb_array[237], (const char *)data, 14);
    }
    {
        // AnimationTree
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 84, 114, 101, 101};
        register_classdb_global(&global_classdb_array[238], (const char *)data, 13);
    }
    {
        // AnimationRootNode
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 82, 111, 111, 116, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[239], (const char *)data, 17);
    }
    {
        // AnimationNode
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[240], (const char *)data, 13);
    }
    {
        // AnimationNodeBlendTree
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 66, 108, 101, 110, 100, 84, 114, 101, 101};
        register_classdb_global(&global_classdb_array[241], (const char *)data, 22);
    }
    {
        // AnimationNodeBlendSpace1D
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 66, 108, 101, 110, 100, 83, 112, 97, 99, 101, 49, 68};
        register_classdb_global(&global_classdb_array[242], (const char *)data, 25);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[244], (const char *)data, 25);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[245], (const char *)data, 33);
    }
    {
        // AnimationNodeBlend3
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[247], (const char *)data, 22);
    }
    {
        // AnimationNodeTimeSeek
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 84, 105, 109, 101, 83, 101, 101, 107};
        register_classdb_global(&global_classdb_array[248], (const char *)data, 21);
    }
    {
        // AnimationNodeTransition
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 84, 114, 97, 110, 115, 105, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[249], (const char *)data, 23);
    }
    {
        // CollisionObject
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 79, 98, 106, 101, 99, 116};
        register_classdb_global(&global_classdb_array[250], (const char *)data, 15);
    }
    {
        // PhysicsBody
        char data[] = {80, 104, 121, 115, 105, 99, 115, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[251], (const char *)data, 11);
    }
    {
        // StaticBody
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[253], (const char *)data, 15);
    }
    {
        // RigidBody
        char data[] = {82, 105, 103, 105, 100, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[254], (const char *)data, 9);
    }
    {
        // KinematicCollision
        char data[] = {75, 105, 110, 101, 109, 97, 116, 105, 99, 67, 111, 108, 108, 105, 115, 105, 111, 110};
        register_classdb_global(&global_classdb_array[255], (const char *)data, 18);
    }
    {
        // KinematicBody
        char data[] = {75, 105, 110, 101, 109, 97, 116, 105, 99, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[256], (const char *)data, 13);
    }
    {
        // SpringArm
        char data[] = {83, 112, 114, 105, 110, 103, 65, 114, 109};
        register_classdb_global(&global_classdb_array[257], (const char *)data, 9);
    }
    {
        // Shape
        char data[] = {83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[258], (const char *)data, 5);
    }
    {
        // PhysicalBone
        char data[] = {80, 104, 121, 115, 105, 99, 97, 108, 66, 111, 110, 101};
        register_classdb_global(&global_classdb_array[259], (const char *)data, 12);
    }
    {
        // SoftBody
        char data[] = {83, 111, 102, 116, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[260], (const char *)data, 8);
    }
    {
        // SkeletonIK
        char data[] = {83, 107, 101, 108, 101, 116, 111, 110, 73, 75};
        register_classdb_global(&global_classdb_array[261], (const char *)data, 10);
    }
    {
        // BoneAttachment
        char data[] = {66, 111, 110, 101, 65, 116, 116, 97, 99, 104, 109, 101, 110, 116};
        register_classdb_global(&global_classdb_array[262], (const char *)data, 14);
    }
    {
        // VehicleBody
        char data[] = {86, 101, 104, 105, 99, 108, 101, 66, 111, 100, 121};
        register_classdb_global(&global_classdb_array[263], (const char *)data, 11);
    }
    {
        // VehicleWheel
        char data[] = {86, 101, 104, 105, 99, 108, 101, 87, 104, 101, 101, 108};
        register_classdb_global(&global_classdb_array[264], (const char *)data, 12);
    }
    {
        // Area
        char data[] = {65, 114, 101, 97};
        register_classdb_global(&global_classdb_array[265], (const char *)data, 4);
    }
    {
        // ProximityGroup
        char data[] = {80, 114, 111, 120, 105, 109, 105, 116, 121, 71, 114, 111, 117, 112};
        register_classdb_global(&global_classdb_array[266], (const char *)data, 14);
    }
    {
        // CollisionShape
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[267], (const char *)data, 14);
    }
    {
        // CollisionPolygon
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 80, 111, 108, 121, 103, 111, 110};
        register_classdb_global(&global_classdb_array[268], (const char *)data, 16);
    }
    {
        // RayCast
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[270], (const char *)data, 17);
    }
    {
        // MultiMesh
        char data[] = {77, 117, 108, 116, 105, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[271], (const char *)data, 9);
    }
    {
        // Curve3D
        char data[] = {67, 117, 114, 118, 101, 51, 68};
        register_classdb_global(&global_classdb_array[272], (const char *)data, 7);
    }
    {
        // Path
        char data[] = {80, 97, 116, 104};
        register_classdb_global(&global_classdb_array[273], (const char *)data, 4);
    }
    {
        // PathFollow
        char data[] = {80, 97, 116, 104, 70, 111, 108, 108, 111, 119};
        register_classdb_global(&global_classdb_array[274], (const char *)data, 10);
    }
    {
        // VisibilityNotifier
        char data[] = {86, 105, 115, 105, 98, 105, 108, 105, 116, 121, 78, 111, 116, 105, 102, 105, 101, 114};
        register_classdb_global(&global_classdb_array[275], (const char *)data, 18);
    }
    {
        // VisibilityEnabler
        char data[] = {86, 105, 115, 105, 98, 105, 108, 105, 116, 121, 69, 110, 97, 98, 108, 101, 114};
        register_classdb_global(&global_classdb_array[276], (const char *)data, 17);
    }
    {
        // WorldEnvironment
        char data[] = {87, 111, 114, 108, 100, 69, 110, 118, 105, 114, 111, 110, 109, 101, 110, 116};
        register_classdb_global(&global_classdb_array[277], (const char *)data, 16);
    }
    {
        // RemoteTransform
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[279], (const char *)data, 5);
    }
    {
        // PinJoint
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[288], (const char *)data, 36);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[289], (const char *)data, 36);
    }
    {
        // VisualShaderNodeOuterProduct
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 79, 117, 116, 101, 114, 80, 114, 111, 100, 117, 99, 116};
        register_classdb_global(&global_classdb_array[290], (const char *)data, 28);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[295], (const char *)data, 32);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[296], (const char *)data, 32);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[297], (const char *)data, 38);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[302], (const char *)data, 29);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[303], (const char *)data, 32);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[304], (const char *)data, 31);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[314], (const char *)data, 32);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[315], (const char *)data, 30);
    }
    {
        // GraphEdit
        char data[] = {71, 114, 97, 112, 104, 69, 100, 105, 116};
        register_classdb_global(&global_classdb_array[316], (const char *)data, 9);
    }
    {
        // Spatial
        char data[] = {83, 112, 97, 116, 105, 97, 108};
        register_classdb_global(&global_classdb_array[317], (const char *)data, 7);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[318], (const char *)data, 35);
    }
    {
        // AnimationNodeOutput
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[320], (const char *)data, 20);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[322], (const char *)data, 17);
    }
    {
        // AnimationNodeAdd3
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 65, 100, 100, 51};
        register_classdb_global(&global_classdb_array[323], (const char *)data, 17);
    }
    {
        // AnimationNodeBlend2
        char data[] = {65, 110, 105, 109, 97, 116, 105, 111, 110, 78, 111, 100, 101, 66, 108, 101, 110, 100, 50};
        register_classdb_global(&global_classdb_array[324], (const char *)data, 19);
    }
    {
        // HingeJoint
        char data[] = {72, 105, 110, 103, 101, 74, 111, 105, 110, 116};
        register_classdb_global(&global_classdb_array[325], (const char *)data, 10);
    }
    {
        // SliderJoint
        char data[] = {83, 108, 105, 100, 101, 114, 74, 111, 105, 110, 116};
        register_classdb_global(&global_classdb_array[326], (const char *)data, 11);
    }
    {
        // ConeTwistJoint
        char data[] = {67, 111, 110, 101, 84, 119, 105, 115, 116, 74, 111, 105, 110, 116};
        register_classdb_global(&global_classdb_array[327], (const char *)data, 14);
    }
    {
        // Generic6DOFJoint
        char data[] = {71, 101, 110, 101, 114, 105, 99, 54, 68, 79, 70, 74, 111, 105, 110, 116};
        register_classdb_global(&global_classdb_array[328], (const char *)data, 16);
    }
    {
        // Shader
        char data[] = {83, 104, 97, 100, 101, 114};
        register_classdb_global(&global_classdb_array[329], (const char *)data, 6);
    }
    {
        // VisualShader
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[335], (const char *)data, 30);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[336], (const char *)data, 31);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[337], (const char *)data, 29);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[339], (const char *)data, 33);
    }
    {
        // VisualShaderNodeScalarOp
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 83, 99, 97, 108, 97, 114, 79, 112};
        register_classdb_global(&global_classdb_array[340], (const char *)data, 24);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[341], (const char *)data, 29);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[342], (const char *)data, 32);
    }
    {
        // VisualShaderNodeScalarFunc
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 83, 99, 97, 108, 97, 114, 70, 117, 110, 99};
        register_classdb_global(&global_classdb_array[343], (const char *)data, 26);
    }
    {
        // VisualShaderNodeVectorFunc
        char data[] = {86, 105, 115, 117, 97, 108, 83, 104, 97, 100, 101, 114, 78, 111, 100, 101, 86, 101, 99, 116, 111, 114, 70, 117, 110, 99};
        register_classdb_global(&global_classdb_array[344], (const char *)data, 26);
    }
    {
        // Particles2D
        char data[] = {80, 97, 114, 116, 105, 99, 108, 101, 115, 50, 68};
        register_classdb_global(&global_classdb_array[345], (const char *)data, 11);
    }
    {
        // Sprite
        char data[] = {83, 112, 114, 105, 116, 101};
        register_classdb_global(&global_classdb_array[346], (const char *)data, 6);
    }
    {
        // AnimatedSprite
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[348], (const char *)data, 10);
    }
    {
        // Line2D
        char data[] = {76, 105, 110, 101, 50, 68};
        register_classdb_global(&global_classdb_array[349], (const char *)data, 6);
    }
    {
        // MeshInstance2D
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[351], (const char *)data, 19);
    }
    {
        // CollisionObject2D
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 79, 98, 106, 101, 99, 116, 50, 68};
        register_classdb_global(&global_classdb_array[352], (const char *)data, 17);
    }
    {
        // KinematicBody2D
        char data[] = {75, 105, 110, 101, 109, 97, 116, 105, 99, 66, 111, 100, 121, 50, 68};
        register_classdb_global(&global_classdb_array[353], (const char *)data, 15);
    }
    {
        // KinematicCollision2D
        char data[] = {75, 105, 110, 101, 109, 97, 116, 105, 99, 67, 111, 108, 108, 105, 115, 105, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[354], (const char *)data, 20);
    }
    {
        // Area2D
        char data[] = {65, 114, 101, 97, 50, 68};
        register_classdb_global(&global_classdb_array[355], (const char *)data, 6);
    }
    {
        // CollisionShape2D
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[356], (const char *)data, 16);
    }
    {
        // RayCast2D
        char data[] = {82, 97, 121, 67, 97, 115, 116, 50, 68};
        register_classdb_global(&global_classdb_array[357], (const char *)data, 9);
    }
    {
        // Polygon2D
        char data[] = {80, 111, 108, 121, 103, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[358], (const char *)data, 9);
    }
    {
        // CurveTexture
        char data[] = {67, 117, 114, 118, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[359], (const char *)data, 12);
    }
    {
        // GradientTexture
        char data[] = {71, 114, 97, 100, 105, 101, 110, 116, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[360], (const char *)data, 15);
    }
    {
        // MeshDataTool
        char data[] = {77, 101, 115, 104, 68, 97, 116, 97, 84, 111, 111, 108};
        register_classdb_global(&global_classdb_array[361], (const char *)data, 12);
    }
    {
        // PrimitiveMesh
        char data[] = {80, 114, 105, 109, 105, 116, 105, 118, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[362], (const char *)data, 13);
    }
    {
        // CapsuleMesh
        char data[] = {67, 97, 112, 115, 117, 108, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[363], (const char *)data, 11);
    }
    {
        // CubeMesh
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[365], (const char *)data, 12);
    }
    {
        // PlaneMesh
        char data[] = {80, 108, 97, 110, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[366], (const char *)data, 9);
    }
    {
        // PrismMesh
        char data[] = {80, 114, 105, 115, 109, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[367], (const char *)data, 9);
    }
    {
        // QuadMesh
        char data[] = {81, 117, 97, 100, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[368], (const char *)data, 8);
    }
    {
        // SphereMesh
        char data[] = {83, 112, 104, 101, 114, 101, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[369], (const char *)data, 10);
    }
    {
        // SpatialMaterial
        char data[] = {83, 112, 97, 116, 105, 97, 108, 77, 97, 116, 101, 114, 105, 97, 108};
        register_classdb_global(&global_classdb_array[370], (const char *)data, 15);
    }
    {
        // MeshLibrary
        char data[] = {77, 101, 115, 104, 76, 105, 98, 114, 97, 114, 121};
        register_classdb_global(&global_classdb_array[371], (const char *)data, 11);
    }
    {
        // RayShape
        char data[] = {82, 97, 121, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[372], (const char *)data, 8);
    }
    {
        // SphereShape
        char data[] = {83, 112, 104, 101, 114, 101, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[373], (const char *)data, 11);
    }
    {
        // BoxShape
        char data[] = {66, 111, 120, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[374], (const char *)data, 8);
    }
    {
        // CapsuleShape
        char data[] = {67, 97, 112, 115, 117, 108, 101, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[375], (const char *)data, 12);
    }
    {
        // CylinderShape
        char data[] = {67, 121, 108, 105, 110, 100, 101, 114, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[376], (const char *)data, 13);
    }
    {
        // HeightMapShape
        char data[] = {72, 101, 105, 103, 104, 116, 77, 97, 112, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[377], (const char *)data, 14);
    }
    {
        // PlaneShape
        char data[] = {80, 108, 97, 110, 101, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[378], (const char *)data, 10);
    }
    {
        // ConvexPolygonShape
        char data[] = {67, 111, 110, 118, 101, 120, 80, 111, 108, 121, 103, 111, 110, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[379], (const char *)data, 18);
    }
    {
        // ConcavePolygonShape
        char data[] = {67, 111, 110, 99, 97, 118, 101, 80, 111, 108, 121, 103, 111, 110, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[380], (const char *)data, 19);
    }
    {
        // SpatialVelocityTracker
        char data[] = {83, 112, 97, 116, 105, 97, 108, 86, 101, 108, 111, 99, 105, 116, 121, 84, 114, 97, 99, 107, 101, 114};
        register_classdb_global(&global_classdb_array[381], (const char *)data, 22);
    }
    {
        // Sky
        char data[] = {83, 107, 121};
        register_classdb_global(&global_classdb_array[382], (const char *)data, 3);
    }
    {
        // PanoramaSky
        char data[] = {80, 97, 110, 111, 114, 97, 109, 97, 83, 107, 121};
        register_classdb_global(&global_classdb_array[383], (const char *)data, 11);
    }
    {
        // ProceduralSky
        char data[] = {80, 114, 111, 99, 101, 100, 117, 114, 97, 108, 83, 107, 121};
        register_classdb_global(&global_classdb_array[384], (const char *)data, 13);
    }
    {
        // StreamTexture
        char data[] = {83, 116, 114, 101, 97, 109, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[385], (const char *)data, 13);
    }
    {
        // ImageTexture
        char data[] = {73, 109, 97, 103, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[386], (const char *)data, 12);
    }
    {
        // AtlasTexture
        char data[] = {65, 116, 108, 97, 115, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[387], (const char *)data, 12);
    }
    {
        // MeshTexture
        char data[] = {77, 101, 115, 104, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[388], (const char *)data, 11);
    }
    {
        // LargeTexture
        char data[] = {76, 97, 114, 103, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[389], (const char *)data, 12);
    }
    {
        // ProxyTexture
        char data[] = {80, 114, 111, 120, 121, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[390], (const char *)data, 12);
    }
    {
        // AnimatedTexture
        char data[] = {65, 110, 105, 109, 97, 116, 101, 100, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[391], (const char *)data, 15);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[392], (const char *)data, 39);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[393], (const char *)data, 30);
    }
    {
        // VisualShaderNodeIf
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[399], (const char *)data, 23);
    }
    {
        // Material
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[402], (const char *)data, 18);
    }
    {
        // CPUParticles2D
        char data[] = {67, 80, 85, 80, 97, 114, 116, 105, 99, 108, 101, 115, 50, 68};
        register_classdb_global(&global_classdb_array[403], (const char *)data, 14);
    }
    {
        // PhysicsBody2D
        char data[] = {80, 104, 121, 115, 105, 99, 115, 66, 111, 100, 121, 50, 68};
        register_classdb_global(&global_classdb_array[404], (const char *)data, 13);
    }
    {
        // StaticBody2D
        char data[] = {83, 116, 97, 116, 105, 99, 66, 111, 100, 121, 50, 68};
        register_classdb_global(&global_classdb_array[405], (const char *)data, 12);
    }
    {
        // RigidBody2D
        char data[] = {82, 105, 103, 105, 100, 66, 111, 100, 121, 50, 68};
        register_classdb_global(&global_classdb_array[406], (const char *)data, 11);
    }
    {
        // Shape2D
        char data[] = {83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[407], (const char *)data, 7);
    }
    {
        // CollisionPolygon2D
        char data[] = {67, 111, 108, 108, 105, 115, 105, 111, 110, 80, 111, 108, 121, 103, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[408], (const char *)data, 18);
    }
    {
        // VisibilityNotifier2D
        char data[] = {86, 105, 115, 105, 98, 105, 108, 105, 116, 121, 78, 111, 116, 105, 102, 105, 101, 114, 50, 68};
        register_classdb_global(&global_classdb_array[409], (const char *)data, 20);
    }
    {
        // VisibilityEnabler2D
        char data[] = {86, 105, 115, 105, 98, 105, 108, 105, 116, 121, 69, 110, 97, 98, 108, 101, 114, 50, 68};
        register_classdb_global(&global_classdb_array[410], (const char *)data, 19);
    }
    {
        // Skeleton2D
        char data[] = {83, 107, 101, 108, 101, 116, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[411], (const char *)data, 10);
    }
    {
        // Bone2D
        char data[] = {66, 111, 110, 101, 50, 68};
        register_classdb_global(&global_classdb_array[412], (const char *)data, 6);
    }
    {
        // Light2D
        char data[] = {76, 105, 103, 104, 116, 50, 68};
        register_classdb_global(&global_classdb_array[413], (const char *)data, 7);
    }
    {
        // LightOccluder2D
        char data[] = {76, 105, 103, 104, 116, 79, 99, 99, 108, 117, 100, 101, 114, 50, 68};
        register_classdb_global(&global_classdb_array[414], (const char *)data, 15);
    }
    {
        // OccluderPolygon2D
        char data[] = {79, 99, 99, 108, 117, 100, 101, 114, 80, 111, 108, 121, 103, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[415], (const char *)data, 17);
    }
    {
        // YSort
        char data[] = {89, 83, 111, 114, 116};
        register_classdb_global(&global_classdb_array[416], (const char *)data, 5);
    }
    {
        // BackBufferCopy
        char data[] = {66, 97, 99, 107, 66, 117, 102, 102, 101, 114, 67, 111, 112, 121};
        register_classdb_global(&global_classdb_array[417], (const char *)data, 14);
    }
    {
        // Camera2D
        char data[] = {67, 97, 109, 101, 114, 97, 50, 68};
        register_classdb_global(&global_classdb_array[418], (const char *)data, 8);
    }
    {
        // Joint2D
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[425], (const char *)data, 18);
    }
    {
        // ParallaxLayer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[427], (const char *)data, 17);
    }
    {
        // RemoteTransform2D
        char data[] = {82, 101, 109, 111, 116, 101, 84, 114, 97, 110, 115, 102, 111, 114, 109, 50, 68};
        register_classdb_global(&global_classdb_array[428], (const char *)data, 17);
    }
    {
        // ParticlesMaterial
        char data[] = {80, 97, 114, 116, 105, 99, 108, 101, 115, 77, 97, 116, 101, 114, 105, 97, 108};
        register_classdb_global(&global_classdb_array[429], (const char *)data, 17);
    }
    {
        // ArrayMesh
        char data[] = {65, 114, 114, 97, 121, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[430], (const char *)data, 9);
    }
    {
        // SurfaceTool
        char data[] = {83, 117, 114, 102, 97, 99, 101, 84, 111, 111, 108};
        register_classdb_global(&global_classdb_array[431], (const char *)data, 11);
    }
    {
        // Texture3D
        char data[] = {84, 101, 120, 116, 117, 114, 101, 51, 68};
        register_classdb_global(&global_classdb_array[432], (const char *)data, 9);
    }
    {
        // TextureArray
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[434], (const char *)data, 9);
    }
    {
        // Font
        char data[] = {70, 111, 110, 116};
        register_classdb_global(&global_classdb_array[435], (const char *)data, 4);
    }
    {
        // BitmapFont
        char data[] = {66, 105, 116, 109, 97, 112, 70, 111, 110, 116};
        register_classdb_global(&global_classdb_array[436], (const char *)data, 10);
    }
    {
        // TextFile
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[438], (const char *)data, 15);
    }
    {
        // DynamicFont
        char data[] = {68, 121, 110, 97, 109, 105, 99, 70, 111, 110, 116};
        register_classdb_global(&global_classdb_array[439], (const char *)data, 11);
    }
    {
        // StyleBox
        char data[] = {83, 116, 121, 108, 101, 66, 111, 120};
        register_classdb_global(&global_classdb_array[440], (const char *)data, 8);
    }
    {
        // StyleBoxEmpty
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[442], (const char *)data, 15);
    }
    {
        // StyleBoxFlat
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[444], (const char *)data, 14);
    }
    {
        // RayShape2D
        char data[] = {82, 97, 121, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[445], (const char *)data, 10);
    }
    {
        // CircleShape2D
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[451], (const char *)data, 30);
    }
    {
        // EditorFileSystem
        char data[] = {69, 100, 105, 116, 111, 114, 70, 105, 108, 101, 83, 121, 115, 116, 101, 109};
        register_classdb_global(&global_classdb_array[452], (const char *)data, 16);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[454], (const char *)data, 12);
    }
    {
        // EditorInterface
        char data[] = {69, 100, 105, 116, 111, 114, 73, 110, 116, 101, 114, 102, 97, 99, 101};
        register_classdb_global(&global_classdb_array[455], (const char *)data, 15);
    }
    {
        // EditorExportPlugin
        char data[] = {69, 100, 105, 116, 111, 114, 69, 120, 112, 111, 114, 116, 80, 108, 117, 103, 105, 110};
        register_classdb_global(&global_classdb_array[456], (const char *)data, 18);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[457], (const char *)data, 30);
    }
    {
        // EditorSceneImporter
        char data[] = {69, 100, 105, 116, 111, 114, 83, 99, 101, 110, 101, 73, 109, 112, 111, 114, 116, 101, 114};
        register_classdb_global(&global_classdb_array[458], (const char *)data, 19);
    }
    {
        // EditorInspector
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[466], (const char *)data, 25);
    }
    {
        // CSGShape
        char data[] = {67, 83, 71, 83, 104, 97, 112, 101};
        register_classdb_global(&global_classdb_array[467], (const char *)data, 8);
    }
    {
        // CSGPrimitive
        char data[] = {67, 83, 71, 80, 114, 105, 109, 105, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[468], (const char *)data, 12);
    }
    {
        // CSGMesh
        char data[] = {67, 83, 71, 77, 101, 115, 104};
        register_classdb_global(&global_classdb_array[469], (const char *)data, 7);
    }
    {
        // CSGSphere
        char data[] = {67, 83, 71, 83, 112, 104, 101, 114, 101};
        register_classdb_global(&global_classdb_array[470], (const char *)data, 9);
    }
    {
        // CSGBox
        char data[] = {67, 83, 71, 66, 111, 120};
        register_classdb_global(&global_classdb_array[471], (const char *)data, 6);
    }
    {
        // CSGCylinder
        char data[] = {67, 83, 71, 67, 121, 108, 105, 110, 100, 101, 114};
        register_classdb_global(&global_classdb_array[472], (const char *)data, 11);
    }
    {
        // CSGTorus
        char data[] = {67, 83, 71, 84, 111, 114, 117, 115};
        register_classdb_global(&global_classdb_array[473], (const char *)data, 8);
    }
    {
        // CSGPolygon
        char data[] = {67, 83, 71, 80, 111, 108, 121, 103, 111, 110};
        register_classdb_global(&global_classdb_array[474], (const char *)data, 10);
    }
    {
        // CSGCombiner
        char data[] = {67, 83, 71, 67, 111, 109, 98, 105, 110, 101, 114};
        register_classdb_global(&global_classdb_array[475], (const char *)data, 11);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[477], (const char *)data, 24);
    }
    {
        // GD2CApi
        char data[] = {71, 68, 50, 67, 65, 112, 105};
        register_classdb_global(&global_classdb_array[478], (const char *)data, 7);
    }
    {
        // GDNativeLibrary
        char data[] = {71, 68, 78, 97, 116, 105, 118, 101, 76, 105, 98, 114, 97, 114, 121};
        register_classdb_global(&global_classdb_array[479], (const char *)data, 15);
    }
    {
        // GDNative
        char data[] = {71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[480], (const char *)data, 8);
    }
    {
        // MultiplayerPeerGDNative
        char data[] = {77, 117, 108, 116, 105, 112, 108, 97, 121, 101, 114, 80, 101, 101, 114, 71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[481], (const char *)data, 23);
    }
    {
        // PacketPeerGDNative
        char data[] = {80, 97, 99, 107, 101, 116, 80, 101, 101, 114, 71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[482], (const char *)data, 18);
    }
    {
        // StreamPeerGDNative
        char data[] = {83, 116, 114, 101, 97, 109, 80, 101, 101, 114, 71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[483], (const char *)data, 18);
    }
    {
        // ARVRInterfaceGDNative
        char data[] = {65, 82, 86, 82, 73, 110, 116, 101, 114, 102, 97, 99, 101, 71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[484], (const char *)data, 21);
    }
    {
        // NativeScript
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[486], (const char *)data, 19);
    }
    {
        // PluginScript
        char data[] = {80, 108, 117, 103, 105, 110, 83, 99, 114, 105, 112, 116};
        register_classdb_global(&global_classdb_array[487], (const char *)data, 12);
    }
    {
        // GDScript
        char data[] = {71, 68, 83, 99, 114, 105, 112, 116};
        register_classdb_global(&global_classdb_array[488], (const char *)data, 8);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[490], (const char *)data, 7);
    }
    {
        // OpenSimplexNoise
        char data[] = {79, 112, 101, 110, 83, 105, 109, 112, 108, 101, 120, 78, 111, 105, 115, 101};
        register_classdb_global(&global_classdb_array[491], (const char *)data, 16);
    }
    {
        // NoiseTexture
        char data[] = {78, 111, 105, 115, 101, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[492], (const char *)data, 12);
    }
    {
        // VisualScriptBuiltinFunc
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 66, 117, 105, 108, 116, 105, 110, 70, 117, 110, 99};
        register_classdb_global(&global_classdb_array[493], (const char *)data, 23);
    }
    {
        // CameraTexture
        char data[] = {67, 97, 109, 101, 114, 97, 84, 101, 120, 116, 117, 114, 101};
        register_classdb_global(&global_classdb_array[494], (const char *)data, 13);
    }
    {
        // TextureLayered
        char data[] = {84, 101, 120, 116, 117, 114, 101, 76, 97, 121, 101, 114, 101, 100};
        register_classdb_global(&global_classdb_array[495], (const char *)data, 14);
    }
    {
        // StyleBoxLine
        char data[] = {83, 116, 121, 108, 101, 66, 111, 120, 76, 105, 110, 101};
        register_classdb_global(&global_classdb_array[496], (const char *)data, 12);
    }
    {
        // PolygonPathFinder
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[498], (const char *)data, 17);
    }
    {
        // AudioStreamPlayer2D
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 80, 108, 97, 121, 101, 114, 50, 68};
        register_classdb_global(&global_classdb_array[499], (const char *)data, 19);
    }
    {
        // AudioStreamPlayer3D
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 80, 108, 97, 121, 101, 114, 51, 68};
        register_classdb_global(&global_classdb_array[500], (const char *)data, 19);
    }
    {
        // AudioStreamSample
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 83, 97, 109, 112, 108, 101};
        register_classdb_global(&global_classdb_array[501], (const char *)data, 17);
    }
    {
        // LineShape2D
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[503], (const char *)data, 14);
    }
    {
        // ConvexPolygonShape2D
        char data[] = {67, 111, 110, 118, 101, 120, 80, 111, 108, 121, 103, 111, 110, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[504], (const char *)data, 20);
    }
    {
        // ConcavePolygonShape2D
        char data[] = {67, 111, 110, 99, 97, 118, 101, 80, 111, 108, 121, 103, 111, 110, 83, 104, 97, 112, 101, 50, 68};
        register_classdb_global(&global_classdb_array[505], (const char *)data, 21);
    }
    {
        // Curve2D
        char data[] = {67, 117, 114, 118, 101, 50, 68};
        register_classdb_global(&global_classdb_array[506], (const char *)data, 7);
    }
    {
        // Path2D
        char data[] = {80, 97, 116, 104, 50, 68};
        register_classdb_global(&global_classdb_array[507], (const char *)data, 6);
    }
    {
        // PathFollow2D
        char data[] = {80, 97, 116, 104, 70, 111, 108, 108, 111, 119, 50, 68};
        register_classdb_global(&global_classdb_array[508], (const char *)data, 12);
    }
    {
        // Navigation2D
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110, 50, 68};
        register_classdb_global(&global_classdb_array[509], (const char *)data, 12);
    }
    {
        // NavigationPolygon
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110, 80, 111, 108, 121, 103, 111, 110};
        register_classdb_global(&global_classdb_array[510], (const char *)data, 17);
    }
    {
        // NavigationPolygonInstance
        char data[] = {78, 97, 118, 105, 103, 97, 116, 105, 111, 110, 80, 111, 108, 121, 103, 111, 110, 73, 110, 115, 116, 97, 110, 99, 101};
        register_classdb_global(&global_classdb_array[511], (const char *)data, 25);
    }
    {
        // SceneState
        char data[] = {83, 99, 101, 110, 101, 83, 116, 97, 116, 101};
        register_classdb_global(&global_classdb_array[512], (const char *)data, 10);
    }
    {
        // PackedScene
        char data[] = {80, 97, 99, 107, 101, 100, 83, 99, 101, 110, 101};
        register_classdb_global(&global_classdb_array[513], (const char *)data, 11);
    }
    {
        // SceneTree
        char data[] = {83, 99, 101, 110, 101, 84, 114, 101, 101};
        register_classdb_global(&global_classdb_array[514], (const char *)data, 9);
    }
    {
        // SceneTreeTimer
        char data[] = {83, 99, 101, 110, 101, 84, 114, 101, 101, 84, 105, 109, 101, 114};
        register_classdb_global(&global_classdb_array[515], (const char *)data, 14);
    }
    {
        // EditorPlugin
        char data[] = {69, 100, 105, 116, 111, 114, 80, 108, 117, 103, 105, 110};
        register_classdb_global(&global_classdb_array[516], (const char *)data, 12);
    }
    {
        // EditorScript
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[518], (const char *)data, 15);
    }
    {
        // EditorFileDialog
        char data[] = {69, 100, 105, 116, 111, 114, 70, 105, 108, 101, 68, 105, 97, 108, 111, 103};
        register_classdb_global(&global_classdb_array[519], (const char *)data, 16);
    }
    {
        // EditorSettings
        char data[] = {69, 100, 105, 116, 111, 114, 83, 101, 116, 116, 105, 110, 103, 115};
        register_classdb_global(&global_classdb_array[520], (const char *)data, 14);
    }
    {
        // EditorSpatialGizmo
        char data[] = {69, 100, 105, 116, 111, 114, 83, 112, 97, 116, 105, 97, 108, 71, 105, 122, 109, 111};
        register_classdb_global(&global_classdb_array[521], (const char *)data, 18);
    }
    {
        // MobileVRInterface
        char data[] = {77, 111, 98, 105, 108, 101, 86, 82, 73, 110, 116, 101, 114, 102, 97, 99, 101};
        register_classdb_global(&global_classdb_array[522], (const char *)data, 17);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[523], (const char *)data, 29);
    }
    {
        // RegExMatch
        char data[] = {82, 101, 103, 69, 120, 77, 97, 116, 99, 104};
        register_classdb_global(&global_classdb_array[524], (const char *)data, 10);
    }
    {
        // RegEx
        char data[] = {82, 101, 103, 69, 120};
        register_classdb_global(&global_classdb_array[525], (const char *)data, 5);
    }
    {
        // AudioStreamOGGVorbis
        char data[] = {65, 117, 100, 105, 111, 83, 116, 114, 101, 97, 109, 79, 71, 71, 86, 111, 114, 98, 105, 115};
        register_classdb_global(&global_classdb_array[526], (const char *)data, 20);
    }
    {
        // VideoStreamTheora
        char data[] = {86, 105, 100, 101, 111, 83, 116, 114, 101, 97, 109, 84, 104, 101, 111, 114, 97};
        register_classdb_global(&global_classdb_array[527], (const char *)data, 17);
    }
    {
        // UPNP
        char data[] = {85, 80, 78, 80};
        register_classdb_global(&global_classdb_array[528], (const char *)data, 4);
    }
    {
        // UPNPDevice
        char data[] = {85, 80, 78, 80, 68, 101, 118, 105, 99, 101};
        register_classdb_global(&global_classdb_array[529], (const char *)data, 10);
    }
    {
        // VisualScript
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116};
        register_classdb_global(&global_classdb_array[530], (const char *)data, 12);
    }
    {
        // VisualScriptNode
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 78, 111, 100, 101};
        register_classdb_global(&global_classdb_array[531], (const char *)data, 16);
    }
    {
        // VisualScriptFunctionState
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 70, 117, 110, 99, 116, 105, 111, 110, 83, 116, 97, 116, 101};
        register_classdb_global(&global_classdb_array[532], (const char *)data, 25);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[534], (const char *)data, 20);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[539], (const char *)data, 20);
    }
    {
        // VisualScriptGlobalConstant
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 71, 108, 111, 98, 97, 108, 67, 111, 110, 115, 116, 97, 110, 116};
        register_classdb_global(&global_classdb_array[540], (const char *)data, 26);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[553], (const char *)data, 20);
    }
    {
        // VisualScriptLocalVarSet
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 76, 111, 99, 97, 108, 86, 97, 114, 83, 101, 116};
        register_classdb_global(&global_classdb_array[554], (const char *)data, 23);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[563], (const char *)data, 18);
    }
    {
        // VisualScriptCondition
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 67, 111, 110, 100, 105, 116, 105, 111, 110};
        register_classdb_global(&global_classdb_array[564], (const char *)data, 21);
    }
    {
        // VisualScriptWhile
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 87, 104, 105, 108, 101};
        register_classdb_global(&global_classdb_array[565], (const char *)data, 17);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[567], (const char *)data, 20);
    }
    {
        // VisualScriptSwitch
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 83, 119, 105, 116, 99, 104};
        register_classdb_global(&global_classdb_array[568], (const char *)data, 18);
    }
    {
        // VisualScriptSelect
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 83, 101, 108, 101, 99, 116};
        register_classdb_global(&global_classdb_array[569], (const char *)data, 18);
    }
    {
        // VisualScriptYield
        char data[] = {86, 105, 115, 117, 97, 108, 83, 99, 114, 105, 112, 116, 89, 105, 101, 108, 100};
        register_classdb_global(&global_classdb_array[570], (const char *)data, 17);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[573], (const char *)data, 19);
    }
    {
        // Physics2DDirectSpaceStateSW
        char data[] = {80, 104, 121, 115, 105, 99, 115, 50, 68, 68, 105, 114, 101, 99, 116, 83, 112, 97, 99, 101, 83, 116, 97, 116, 101, 83, 87};
        register_classdb_global(&global_classdb_array[574], (const char *)data, 27);
    }
    {
        // VideoStreamWebm
        char data[] = {86, 105, 100, 101, 111, 83, 116, 114, 101, 97, 109, 87, 101, 98, 109};
        register_classdb_global(&global_classdb_array[575], (const char *)data, 15);
    }
    {
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[577], (const char *)data, 28);
    }
    {
        // WebRTCDataChannel
        char data[] = {87, 101, 98, 82, 84, 67, 68, 97, 116, 97, 67, 104, 97, 110, 110, 101, 108};
        register_classdb_global(&global_classdb_array[578], (const char *)data, 17);
    }
    {
        // WebRTCMultiplayer
        char data[] = {87, 101, 98, 82, 84, 67, 77, 117, 108, 116, 105, 112, 108, 97, 121, 101, 114};
        register_classdb_global(&global_classdb_array[579], (const char *)data, 17);
    }
    {
        // WebRTCDataChannelGDNative
        char data[] = {87, 101, 98, 82, 84, 67, 68, 97, 116, 97, 67, 104, 97, 110, 110, 101, 108, 71, 68, 78, 97, 116, 105, 118, 101};
        register_classdb_global(&global_classdb_array[580], (const char *)data, 25);
    }
    {
        // WebSocketMultiplayerPeer
        char data[] = {87, 101, 98, 83, 111, 99, 107, 101, 116, 77, 117, 108, 116, 105, 112, 108, 97, 121, 101, 114, 80, 101, 101, 114};
        register_classdb_global(&global_classdb_array[581], (const char *)data, 24);
    }
    {
        // WebSocketServer
        char data[] = {87, 101, 98, 83, 111, 99, 107, 101, 116, 83, 101, 114, 118, 101, 114};
        register_classdb_global(&global_classdb_array[582], (const char *)data, 15);
    }
    {
        // WebSocketClient
        char data[] = {87, 101, 98, 83, 111, 99, 107, 101, 116, 67, 108, 105, 101, 110, 116};
        register_classdb_global(&global_classdb_array[583], (const char *)data, 15);
    }
    {
        // WebSocketPeer
        char data[] = {87, 101, 98, 83, 111, 99, 107, 101, 116, 80, 101, 101, 114};
        register_classdb_global(&global_classdb_array[584], (const char *)data, 13);
    }
    {
        // BulletPhysicsServer
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[586], (const char *)data, 28);
    }
    {
        // Physics2DServerSW
    ...
    }
    {
        ...
        register_classdb_global(&global_classdb_array[588], (const char *)data, 26);
    }
    {
        // GDScriptNativeClass
        char data[] = {71, 68, 83, 99, 114, 105, 112, 116, 78, 97, 116, 105, 118, 101, 67, 108, 97, 115, 115};
        register_classdb_global(&global_classdb_array[589], (const char *)data, 19);
    }
    {
        ...
        register_classdb_global(&global_classdb_array[590], (const char *)data, 29);
    }
    {
    ...
    }
    {
        ...
        int bytesRead;
        gd2c10->variant_decode(&Class_1_constants[0], data, 8, &bytesRead, true);
    }
    {
        uint8_t data[] = {2, 0, 0, 0, 3, 0, 0, 0};
        int bytesRead;
        gd2c10->variant_decode(&Class_3_constants[0], data, 8, &bytesRead, true);
    }
