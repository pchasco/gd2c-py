                ...
                #include "gd2c.h"
                    method_wrapper_ptr_t Class_1_vtable_wrappers[11];
        variant_method_ptr_t Class_1_vtable_methods[11];
        godot_string Class_1_vtable_method_names[11];
...
godot_variant Class_1_call_method_local_const[1];
int Class_1_call_method_local_const_initialized = 0;
godot_variant Class_1_called_method_local_const[1];
int Class_1_called_method_local_const_initialized = 0;
godot_variant Class_1_natural_loop_local_const[3];
int Class_1_natural_loop_local_const_initialized = 0;
...
godot_variant Class_1_godot_construct_array_local_const[3];
int Class_1_godot_construct_array_local_const_initialized = 0;
godot_variant Class_1_godot_array_set_local_const[1];
int Class_1_godot_array_set_local_const_initialized = 0;
godot_variant Class_1_godot_array_get_local_const[1];
int Class_1_godot_array_get_local_const_initialized = 0;
godot_variant Class_1_godot_set_named_local_const[1];
int Class_1_godot_set_named_local_const_initialized = 0;
